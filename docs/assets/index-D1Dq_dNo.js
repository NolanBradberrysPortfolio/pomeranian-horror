...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Fo(e,t,n){let r=new Float32Array(xo),i=new V(0,1,0);return new Xi({name:`SphericalGaussianBlur`,defines:{n:xo,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:Ro(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Io(){return new Xi({name:`EquirectangularToCubeUV`,uniforms:{envMap:{value:null}},vertexShader:Ro(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Lo(){return new Xi({name:`CubemapToCubeUV`,uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Ro(),fragmentShader:`
	...
	`}var zo=class extends jt{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new ti(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
void main() {
	...
	if ( coord.x >= 1.0 ) {
		...
		}`},Tl=class{constructor(){this.isPass=!0,this.enabled=!0,this.needsSwap=!0,this.clear=!1,this.renderToScreen=!1}setSize(){}render(){console.error(`THREE.Pass: .render() must be implemented in derived pass.`)}dispose(){}},El=new Ba(-1,1,1,-1,0,1),Dl=new class extends fr{constructor(){super(),this.setAttribute(`position`,new er([-1,3,0,-1,-1,0,3,-1,0],3)),this.setAttribute(`uv`,new er([0,2,0,0,2,0],2))}},Ol=class{constructor(e){this._mesh=new G(Dl,e)}dispose(){this._mesh.geometry.dispose()}render(e){e.render(this._mesh,El)}get material(){return this._mesh.material}set material(e){this._mesh.material=e}},kl=class extends Tl{constructor(e,t=`tDiffuse`){super(),this.textureID=t,this.uniforms=null,this.material=null,e instanceof Xi?(this.uniforms=e.uniforms,this.material=e):e&&(this.uniforms=qi.clone(e.uniforms),this.material=new Xi({name:e.name===void 0?`unspecified`:e.name,defines:Object.assign({},e.defines),uniforms:this.uniforms,vertexShader:e.vertexShader,fragmentShader:e.fragmentShader})),this._fsQuad=new Ol(this.material)}render(e,t,n){this.uniforms[this.textureID]&&(this.uniforms[this.textureID].value=n.texture),this._fsQuad.material=this.material,this.renderToScreen?(e.setRenderTarget(null),this._fsQuad.render(e)):(e.setRenderTarget(t),this.clear&&e.clear(e.autoClearColor,e.autoClearDepth,e.autoClearStencil),this._fsQuad.render(e))}dispose(){this.material.dispose(),this._fsQuad.dispose()}},Al=class extends Tl{constructor(e,t){super(),this.scene=e,this.camera=t,this.clear=!0,this.needsSwap=!1,this.inverse=!1}render(e,t,n){let r=e.getContext(),i=e.state;i.buffers.color.setMask(!1),i.buffers.depth.setMask(!1),i.buffers.color.setLocked(!0),i.buffers.depth.setLocked(!0);let a,o;this.inverse?(a=0,o=1):(a=1,o=0),i.buffers.stencil.setTest(!0),i.buffers.stencil.setOp(r.REPLACE,r.REPLACE,r.REPLACE),i.buffers.stencil.setFunc(r.ALWAYS,a,4294967295),i.buffers.stencil.setClear(o),i.buffers.stencil.setLocked(!0),e.setRenderTarget(n),this.clear&&e.clear(),e.render(this.scene,this.camera),e.setRenderTarget(t),this.clear&&e.clear(),e.render(this.scene,this.camera),i.buffers.color.setLocked(!1),i.buffers.depth.setLocked(!1),i.buffers.color.setMask(!0),i.buffers.depth.setMask(!0),i.buffers.stencil.setLocked(!1),i.buffers.stencil.setFunc(r.EQUAL,1,4294967295),i.buffers.stencil.setOp(r.KEEP,r.KEEP,r.KEEP),i.buffers.stencil.setLocked(!0)}},jl=class extends Tl{constructor(){super(),this.needsSwap=!1}render(e){e.state.buffers.stencil.setLocked(!1),e.state.buffers.stencil.setTest(!1)}},Ml=class{constructor(e,t){if(this.renderer=e,this._pixelRatio=e.getPixelRatio(),t===void 0){let n=e.getSize(new B);this._width=n.width,this._height=n.height,t=new jt(this._width*this._pixelRatio,this._height*this._pixelRatio,{type:g}),t.texture.name=`EffectComposer.rt1`}else this._width=t.width,this._height=t.height;this.renderTarget1=t,this.renderTarget2=t.clone(),this.renderTarget2.texture.name=`EffectComposer.rt2`,this.writeBuffer=this.renderTarget1,this.readBuffer=this.renderTarget2,this.renderToScreen=!0,this.passes=[],this.copyPass=new kl(wl),this.copyPass.material.blending=0,this.timer=new Ga}swapBuffers(){let e=this.readBuffer;this.readBuffer=this.writeBuffer,this.writeBuffer=e}addPass(e){this.passes.push(e),e.setSize(this._width*this._pixelRatio,this._height*this._pixelRatio)}insertPass(e,t){this.passes.splice(t,0,e),e.setSize(this._width*this._pixelRatio,this._height*this._pixelRatio)}removePass(e){let t=this.passes.indexOf(e);t!==-1&&this.passes.splice(t,1)}isLastEnabledPass(e){for(let t=e+1;t<this.passes.length;t++)if(this.passes[t].enabled)return!1;return!0}render(e){this.timer.update(),e===void 0&&(e=this.timer.getDelta());let t=this.renderer.getRenderTarget(),n=!1;for(let t=0,r=this.passes.length;t<r;t++){let r=this.passes[t];if(r.enabled!==!1){if(r.renderToScreen=this.renderToScreen&&this.isLastEnabledPass(t),r.render(this.renderer,this.writeBuffer,this.readBuffer,e,n),r.needsSwap){if(n){let t=this.renderer.getContext(),n=this.renderer.state.buffers.stencil;n.setFunc(t.NOTEQUAL,1,4294967295),this.copyPass.render(this.renderer,this.writeBuffer,this.readBuffer,e),n.setFunc(t.EQUAL,1,4294967295)}this.swapBuffers()}Al!==void 0&&(r instanceof Al?n=!0:r instanceof jl&&(n=!1))}}this.renderer.setRenderTarget(t)}reset(e){if(e===void 0){let t=this.renderer.getSize(new B);this._pixelRatio=this.renderer.getPixelRatio(),this._width=t.width,this._height=t.height,e=this.renderTarget1.clone(),e.setSize(this._width*this._pixelRatio,this._height*this._pixelRatio)}this.renderTarget1.dispose(),this.renderTarget2.dispose(),this.renderTarget1=e,this.renderTarget2=e.clone(),this.writeBuffer=this.renderTarget1,this.readBuffer=this.renderTarget2}setSize(e,t){this._width=e,this._height=t;let n=this._width*this._pixelRatio,r=this._height*this._pixelRatio;this.renderTarget1.setSize(n,r),this.renderTarget2.setSize(n,r);for(let e=0;e<this.passes.length;e++)this.passes[e].setSize(n,r)}setPixelRatio(e){this._pixelRatio=e,this.setSize(this._width,this._height)}dispose(){this.renderTarget1.dispose(),this.renderTarget2.dispose(),this.copyPass.dispose()}},Nl=class extends Tl{constructor(e,t,n=null,r=null,i=null){super(),this.scene=e,this.camera=t,this.overrideMaterial=n,this.clearColor=r,this.clearAlpha=i,this.clear=!0,this.clearDepth=!1,this.needsSwap=!1,this.isRenderPass=!0,this._oldClearColor=new W}render(e,t,n){let r=e.autoClear;e.autoClear=!1;let i,a;this.overrideMaterial!==null&&(a=this.scene.overrideMaterial,this.scene.overrideMaterial=this.overrideMaterial),this.clearColor!==null&&(e.getClearColor(this._oldClearColor),e.setClearColor(this.clearColor,e.getClearAlpha())),this.clearAlpha!==null&&(i=e.getClearAlpha(),e.setClearAlpha(this.clearAlpha)),this.clearDepth==1&&e.clearDepth(),e.setRenderTarget(this.renderToScreen?null:n),this.clear===!0&&e.clear(e.autoClearColor,e.autoClearDepth,e.autoClearStencil),e.render(this.scene,this.camera),this.clearColor!==null&&e.setClearColor(this._oldClearColor),this.clearAlpha!==null&&e.setClearAlpha(i),this.overrideMaterial!==null&&(this.scene.overrideMaterial=a),e.autoClear=r}},Pl={name:`LuminosityHighPassShader`,uniforms:{tDiffuse:{value:null},luminosityThreshold:{value:1},smoothWidth:{value:1},defaultColor:{value:new W(0)},defaultOpacity:{value:0}},vertexShader:`
		...
		void main() {
			...
			gl_FragColor = mix( outputColor, texel, alpha );
				...
				}`})}};Fl.BlurDirectionX=new B(1,0),Fl.BlurDirectionY=new B(0,1);var Il=document.querySelector(`#app`),Ll=document.querySelector(`#game-canvas`),Rl=document.querySelector(`#start-screen`),zl=document.querySelector(`#result-screen`),Bl=document.querySelector(`#start-button`),Vl=document.querySelector(`#restart-button`),Hl=document.querySelector(`#result-kicker`),Ul=document.querySelector(`#result-title`),Wl=document.querySelector(`#result-copy`),Gl=document.querySelector(`#hud`),Kl=document.querySelector(`#touch-layer`),ql=document.querySelector(`#joystick`),Jl=document.querySelector(`#joystick span`),Yl=document.querySelector(`#spray-button`),Xl=document.querySelector(`#flashlight-button`),Zl=document.querySelector(`#fear-fill`),Ql=document.querySelector(`#key-counter`),$l=document.querySelector(`#message-feed`),eu=document.querySelector(`#jumpscare`),tu=document.querySelector(`#jumpscare-sprite`),nu=document.querySelector(`#blood-flash`),ru=document.querySelector(`#weapon-view`),iu=new URLSearchParams(window.location.search).has(`test`)&&/^(localhost|127\.0\.0\.1|\[::1\])$/.test(window.location.hostname),au=3,ou=17,su=25,cu=3.4,lu=1.62,uu=.42,du=3.05,fu=.0031,pu=.22,mu=3,hu=34,gu=32,_u={c:1,r:1},vu={c:23,r:1},yu={c:2,r:14},bu=[{c:10,r:2},{c:3,r:8},{c:21,r:14}],xu=new vn;xu.background=new W(263686),xu.fog=new _n(197893,.02);var Su=new Fa(73,window.innerWidth/window.innerHeight,.03,85);Su.rotation.order=`YXZ`;var Cu=matchMedia(`(pointer: coarse)`).matches||/Android|iPhone|iPad|iPod/i.test(navigator.userAgent),wu=new Cl({canvas:Ll,antialias:!Cu,powerPreference:`high-performance`});wu.shadowMap.enabled=!Cu,wu.shadowMap.type=1,wu.outputColorSpace=ze,wu.toneMapping=4,wu.toneMappingExposure=1.05;var Tu=Cu?1.25:1.85;wu.setPixelRatio(Math.min(window.devicePixelRatio||1,Tu)),wu.setSize(window.innerWidth,window.innerHeight,!1);var Eu=null,Du=null;try{Cu||(Eu=new Ml(wu),Eu.addPass(new Nl(xu,Su)),Du=new Fl(new B(window.innerWidth,window.innerHeight),.22,.35,.72),Eu.addPass(Du))}catch{Eu=null}var Ou=performance.now(),ku=Tf(3713),Au=Ju(),ju=new Set,Mu={walls:[],props:[],width:su*au,depth:ou*au},J=Xu(),Nu=new ln,Pu=new ln,Fu=new ln,Iu=new ln,Y=new ln;xu.add(Nu,Pu,Fu,Iu,Y);var Lu=null;_d();var Ru=new Ca(13950927,526085,.31);xu.add(Ru);var zu=new La(16774350,78,28,Math.PI/6.3,.58,1.42);zu.castShadow=!Cu,zu.shadow.mapSize.set(Cu?512:1024,Cu?512:1024),zu.shadow.camera.near=.15,zu.shadow.camera.far=22,zu.target.position.set(0,0,-1),xu.add(zu,zu.target);var Bu=new za(16772553,.72,7.5,1.35);xu.add(Bu);var Vu=bd();xu.add(Vu);var X={pos:new V,yaw:-Math.PI/2,pitch:0,fear:0,keys:0,bob:0,shake:0,lastSafe:new V},Z={pos:new V,vel:new V,path:[],pathTimer:0,stun:0,retreat:0,barkTimer:1.2,growlTimer:0,biteCooldown:0,flashlightExposure:0,squirtHits:0,flashlightRepels:0,jumpscares:0,vanishes:0,hiddenTimer:0,apparitionTimer:0,apparitionCooldown:0,warpCooldown:7.5,stareTime:0,seenTimer:0,lastDistance:99},Q={moveX:0,moveY:0,lookX:0,lookY:0,testMoveX:0,testMoveY:0,testLookX:0,testLookY:0,testUntil:0,keys:new Set,flashlightOn:!0,sprayCooldown:0,joystickPointer:null,lookPointer:null,lookLast:{x:0,y:0}},$={state:`idle`,time:0,messageTimer:0,message:``,collectedKeys:[],sprayParticles:[],fps:60,fpsTimer:0,fpsFrames:0,threat:0,scoreEvents:{keyPickups:0,exitUnlocked:!1,won:!1,dogRepelled:!1,dogVanished:!1,apparitionSeen:!1,jumpscareSeen:!1,mobileInputSeen:!1}},Hu=new Set;function Uu(e,t){let n=window.setTimeout(()=>{Hu.delete(n),e()},t);return Hu.add(n),n}function Wu(){for(let e of Hu)window.clearTimeout(e);Hu.clear()}var Gu=[],Ku=null,qu=null;Yu(),dd(),pd(),hd(),gd(),jd(!1),xd();function Ju(){let e=Array.from({length:ou},()=>Array.from({length:su},()=>`.`));for(let t=0;t<ou;t+=1)e[t][0]=`#`,e[t][su-1]=`#`;for(let t=0;t<su;t+=1)e[0][t]=`#`,e[ou-1][t]=`#`;let t=(t,n,r,i=[])=>{for(let a=n;a<=r;a+=1)i.includes(a)||(e[a][t]=`#`)},n=(t,n,r,i=[])=>{for(let a=n;a<=r;a+=1)i.includes(a)||(e[t][a]=`#`)};t(6,1,15,[4,10,14]),t(13,1,15,[5,11,15]),t(19,3,15,[8,13]),n(5,1,23,[3,10,16,22]),n(10,1,23,[4,8,15,22]),n(13,6,23,[11,18,21]),t(3,10,15,[12]),t(22,5,12,[7,10]),((t,n,r)=>{for(let i=n;i<=r;i+=1)e[t][i]=`.`})(8,3,21),((t,n,r)=>{for(let i=n;i<=r;i+=1)e[i][t]=`.`})(21,8,14);let r=[_u,vu,yu,...bu];for(let t of r)e[t.r][t.c]=`.`;return e}function Yu(){J.floor.map.repeat.set(su/2.2,ou/2.2);let e=new G(new Ri(su*au,ou*au,su,ou),J.floor);e.rotation.x=-Math.PI/2,e.receiveShadow=!0,xu.add(e);let t=new G(new Ri(su*au,ou*au),J.ceiling);t.position.y=cu,t.rotation.x=Math.PI/2,t.receiveShadow=!0,xu.add(t);let n=Au.flat().filter(e=>e===`#`).length,r=new Kr(new oi(au,cu,au),J.wall,n);r.castShadow=!0,r.receiveShadow=!0;let i=new Pt,a=0;for(let e=0;e<ou;e+=1)for(let t=0;t<su;t+=1){if(Au[e][t]!==`#`)continue;let n=gf(t,e);i.compose(new V(n.x,cu/2,n.z),new ft,new V(1,1+ku()*.04,1)),r.setMatrixAt(a,i),ju.add(`${t},${e}`),Mu.walls.push({c:t,r:e,minX:n.x-au/2,maxX:n.x+au/2,minZ:n.z-au/2,maxZ:n.z+au/2}),a+=1}r.instanceMatrix.needsUpdate=!0,Nu.add(r),ed(),td(),nd()}function Xu(){let t=Zu(`abandoned-wall.png`),n=Zu(`abandoned-floor.png`),r=Qu(512);for(let i of[t,n,r])i.wrapS=e,i.wrapT=e,i.colorSpace=ze,i.anisotropy=Math.min(8,wu.capabilities.getMaxAnisotropy());return{wall:new Qi({map:t,color:8553074,roughness:.94,metalness:.02,bumpMap:t,bumpScale:.06}),floor:new Qi({map:n,color:7106919,roughness:.88,metalness:.08,bumpMap:n,bumpScale:.04}),ceiling:new Qi({map:r,color:3487541,roughness:.98,metalness:.01}),trim:new Qi({color:3093293,roughness:.72,metalness:.28}),brass:new Qi({color:14202963,roughness:.32,metalness:.85,emissive:3810565,emissiveIntensity:.22}),exit:new Qi({color:2634278,roughness:.7,metalness:.1}),exitUnlocked:new Qi({color:5335878,roughness:.55,metalness:.14,emissive:2375451,emissiveIntensity:.35}),darkMetal:new Qi({color:1580062,roughness:.52,metalness:.78}),crate:new Qi({color:6705467,roughness:.86,metalness:.02}),paper:new Qi({color:13222312,roughness:.93,metalness:.01}),fabric:new Qi({color:3490364,roughness:.97,metalness:0}),stain:new Cr({color:1641737,transparent:!0,opacity:.56,depthWrite:!1}),wire:new Qi({color:394758,roughness:.55,metalness:.5}),warning:new Qi({color:8350500,roughness:.74,metalness:.18,emissive:1905155,emissiveIntensity:.12}),wet:new Qi({color:1713446,roughness:.38,metalness:.05,transparent:!0,opacity:.62}),fur:new Qi({color:7029286,roughness:.98,metalness:0}),furDark:new Qi({color:2759442,roughness:.98,metalness:0}),furLight:new Qi({color:16052454,roughness:.95,metalness:0}),furCoffee:new Qi({color:9137218,roughness:.96,metalness:0}),muzzle:new Qi({color:10519644,roughness:.92,metalness:0}),tooth:new Qi({color:16773586,roughness:.62,metalness:0,emissive:2758665,emissiveIntensity:.08}),eye:new Qi({color:853764,roughness:.36,metalness:0,emissive:16761707,emissiveIntensity:.08}),water:new Qi({color:10217727,roughness:.2,metalness:0,transparent:!0,opacity:.68,emissive:1525850,emissiveIntensity:.3})}}function Zu(t){let n=new xa().load(`/pomeranian-horror/assets/${t}`);return n.wrapS=e,n.wrapT=e,n.colorSpace=ze,n.anisotropy=Math.min(8,wu.capabilities.getMaxAnisotropy()),n}function Qu(e){return $u(e,(e,t,n)=>{e.fillStyle=`#303331`,e.fillRect(0,0,t,t);for(let r=0;r<2400;r+=1){let r=Math.floor(28+n()*55);e.fillStyle=`rgba(${r},${r+2},${r},${.08+n()*.09})`,e.fillRect(n()*t,n()*t,1+n()*3,1+n()*3)}for(let r=0;r<18;r+=1)e.fillStyle=`rgba(0, 0, 0, ${.18+n()*.24})`,e.fillRect(n()*t,n()*t,20+n()*90,4+n()*14)})}function $u(e,t){let n=document.createElement(`canvas`);n.width=e,n.height=e,t(n.getContext(`2d`),e,Tf(e*17+53));let r=new ni(n);return r.needsUpdate=!0,r}function ed(){let e=[{c:3,r:2,color:16771258,intensity:.34},{c:10,r:3,color:12576511,intensity:.26},{c:16,r:7,color:16766881,intensity:.21},{c:4,r:12,color:12124113,intensity:.19},{c:21,r:14,color:16769966,intensity:.3},{c:22,r:1,color:14417865,intensity:.42}],t=new li(.42,.42,.08,20);for(let n of e){let e=gf(n.c,n.r),r=new G(t,J.darkMetal);r.position.set(e.x,cu-.08,e.z),r.castShadow=!0,Pu.add(r);let i=new za(n.color,n.intensity,11,1.6);i.position.set(e.x,cu-.3,e.z),i.castShadow=!Cu&&n.intensity>.28,i.userData.baseIntensity=n.intensity,i.userData.flicker=ku()*20,Pu.add(i),Mu.props.push(i)}}function td(){let e=J.trim,t=new oi(au*.88,.14,.12),n=new oi(.12,1.85,.12);for(let r of[{c:6,r:4,axis:`z`},{c:6,r:10,axis:`z`},{c:13,r:5,axis:`z`},{c:13,r:11,axis:`z`},{c:19,r:8,axis:`z`},{c:3,r:5,axis:`x`},{c:10,r:5,axis:`x`},{c:15,r:10,axis:`x`},{c:18,r:13,axis:`x`}]){let i=gf(r.c,r.r),a=new G(t,e);a.position.set(i.x,2.12,i.z),r.axis===`x`&&(a.rotation.y=Math.PI/2),a.castShadow=!0,Pu.add(a);let o=r.axis===`x`?[new V(0,0,-3*.42),new V(0,0,au*.42)]:[new V(-3*.42,0,0),new V(au*.42,0,0)];for(let t of o){let r=new G(n,e);r.position.set(i.x+t.x,1.02,i.z+t.z),r.castShadow=!0,Pu.add(r)}}}function nd(){let e=new oi(.85,.65,.85),t=new li(.06,.06,1.4,12),n=new ci(.7,24);for(let r=1;r<ou-1;r+=1)for(let i=1;i<su-1;i+=1){if(!hf(i,r)||ud(i,r))continue;let a=ku(),o=gf(i,r);if(a<.055){let t=new G(e,J.crate);t.position.set(o.x+(ku()-.5)*1.2,.33,o.z+(ku()-.5)*1.2),t.rotation.y=ku()*Math.PI,t.scale.setScalar(.75+ku()*.7),t.castShadow=!0,t.receiveShadow=!0,Pu.add(t)}else if(a<.095){let e=new G(t,J.darkMetal);e.position.set(o.x+(ku()-.5)*1.4,.11,o.z+(ku()-.5)*1.4),e.rotation.z=Math.PI/2,e.rotation.y=ku()*Math.PI,e.castShadow=!0,Pu.add(e)}else if(a<.135){let e=new G(n,J.wet);e.position.set(o.x+(ku()-.5)*1.3,.012,o.z+(ku()-.5)*1.3),e.rotation.x=-Math.PI/2,e.scale.set(.7+ku()*1.4,.34+ku()*.7,1),Pu.add(e)}}rd(),sd()}function rd(){let e=new oi(1,1,1),t=new oi(1.65,.12,.16),n=new oi(1.45,.18,2.1),r=new oi(.62,.08,.58),i=new oi(.62,.72,.08),a=new li(.035,.035,.58,8),o=new ci(.72,24),s=[{c:5,r:2,rot:.1},{c:15,r:4,rot:Math.PI*.52},{c:22,r:9,rot:-.35}];for(let t of s){let n=gf(t.c,t.r);id(e,J.darkMetal,n.x,.74,n.z,.92,1.48,.48,t.rot),id(e,J.paper,n.x+Math.cos(t.rot)*.05,1.16,n.z+Math.sin(t.rot)*.05,.72,.06,.07,t.rot)}for(let t of[{c:10,r:4,rot:-.25},{c:4,r:11,rot:.55},{c:20,r:14,rot:-.5}]){let r=gf(t.c,t.r);id(n,J.fabric,r.x-.35,.13,r.z+.18,1,1,1,t.rot),id(e,J.paper,r.x+.55,.25,r.z-.55,.78,.08,.48,t.rot+.2),ad(o,r.x+.2,r.z+.7,1.1,.46,t.rot+.1)}for(let e of[{c:8,r:8,rot:.8},{c:17,r:6,rot:-.55},{c:14,r:12,rot:2.2},{c:21,r:3,rot:-1.1}]){let t=gf(e.c,e.r);id(r,J.crate,t.x,.42,t.z,1,1,1,e.rot),id(i,J.crate,t.x-Math.sin(e.rot)*.32,.78,t.z-Math.cos(e.rot)*.32,1,1,1,e.rot);for(let n of[-.24,.24])for(let r of[-.2,.2]){let i=new G(a,J.darkMetal);i.position.set(t.x+Math.cos(e.rot)*n-Math.sin(e.rot)*r,.2,t.z+Math.sin(e.rot)*n+Math.cos(e.rot)*r),i.rotation.z=(ku()-.5)*.22,i.castShadow=!0,Pu.add(i)}}let c=[{c:2,r:6,rot:0},{c:12,r:15,rot:Math.PI},{c:19,r:2,rot:Math.PI},{c:23,r:12,rot:-Math.PI/2}];for(let e of c){let n=gf(e.c,e.r);for(let r=0;r<3;r+=1){let i=new G(t,J.crate);i.position.set(n.x,1.12+r*.29,n.z),i.rotation.y=e.rot+(r-1)*.08,i.translateZ(-3*.49),i.castShadow=!0,Pu.add(i)}}od(6,12,9,12),od(16,10,16,13),od(21,5,23,5)}function id(e,t,n,r,i,a,o,s,c=0){let l=new G(e,t);return l.position.set(n,r,i),l.scale.set(a,o,s),l.rotation.y=c,l.castShadow=!0,l.receiveShadow=!0,Pu.add(l),l}function ad(e,t,n,r,i,a){let o=new G(e,J.stain);o.position.set(t,.018,n),o.rotation.x=-Math.PI/2,o.rotation.z=a,o.scale.set(r,i,1),Pu.add(o)}function od(e,t,n,r){let i=gf(e,t),a=gf(n,r),o=new G(new Vi(new bi([new V(i.x,cu-.18,i.z),new V((i.x+a.x)/2,cu-.78,(i.z+a.z)/2),new V(a.x,cu-.28,a.z)]),12,.025,8),J.wire);o.castShadow=!0,Pu.add(o)}function sd(){let e=new Cr({map:cd(256),transparent:!0,opacity:.86}),t=new Cr({map:ld(256),transparent:!0,opacity:.52,depthWrite:!1}),n=[{c:1,r:1,rot:Math.PI/2,mat:e,w:1.18,h:.72},{c:1,r:2,rot:Math.PI/2,mat:t,w:1.65,h:1.18},{c:5,r:5,rot:0,mat:e,w:1.2,h:.72},{c:17,r:10,rot:Math.PI,mat:e,w:1.2,h:.72},{c:7,r:14,rot:Math.PI,mat:t,w:1.7,h:1.25},{c:20,r:8,rot:-Math.PI/2,mat:t,w:1.6,h:1.1},{c:3,r:13,rot:Math.PI/2,mat:t,w:1.55,h:1.25}];for(let e of n){let t=gf(e.c,e.r),n=new G(new Ri(e.w,e.h),e.mat);n.position.set(t.x,1.55,t.z),n.rotation.y=e.rot,n.translateZ(-3*.49),Pu.add(n)}}function cd(e){return $u(e,(e,t)=>{e.fillStyle=`#6e5f28`,e.fillRect(0,0,t,t),e.strokeStyle=`#1a1308`,e.lineWidth=12,e.strokeRect(10,10,t-20,t-20),e.fillStyle=`#1a1308`,e.font=`bold 44px Arial`,e.textAlign=`center`,e.fillText(`KEEP`,t/2,88),e.fillText(`QUIET`,t/2,145),e.fillRect(52,178,t-104,14)})}function ld(e){return $u(e,(e,t,n)=>{e.clearRect(0,0,t,t),e.strokeStyle=`rgba(5, 6, 5, 0.82)`;for(let r=0;r<36;r+=1){e.lineWidth=1+n()*3,e.beginPath();let r=20+n()*(t-40),i=20+n()*(t-40);e.moveTo(r,i),e.lineTo(r+(n()-.5)*96,i+38+n()*70),e.stroke()}})}function ud(e,t){return[_u,vu,yu,...bu].some(n=>Math.abs(n.c-e)<=1&&Math.abs(n.r-t)<=1)}function dd(){let e=gf(vu.c,vu.r),t=new ln,n=new G(new oi(1.65,2.6,.22),J.exit);n.position.set(0,1.3,-1.05),n.castShadow=!0,n.receiveShadow=!0,t.add(n);let r=new G(new zi(.11,16,12),J.brass);r.position.set(-.52,1.22,-.91),r.castShadow=!0,t.add(r);let i=fd(256),a=new G(new Ri(1.25,.44),new Cr({map:i,transparent:!0}));a.position.set(0,2.82,-.88),t.add(a),qu=new za(12255119,.45,5.5,1.2),qu.position.set(0,2.62,-.7),t.add(qu),t.position.set(e.x,0,e.z),t.rotation.y=Math.PI/2,Ku=t,xu.add(t)}function fd(e){return $u(e,(e,t)=>{e.fillStyle=`#18261d`,e.fillRect(0,0,t,t),e.fillStyle=`#bdf2a6`,e.fillRect(8,8,t-16,t-16),e.fillStyle=`#163018`,e.font=`bold 96px Arial`,e.textAlign=`center`,e.textBaseline=`middle`,e.fillText(`EXIT`,t/2,t/2+6)})}function pd(){for(let e=0;e<bu.length;e+=1){let t=bu[e],n=gf(t.c,t.r),r=md();r.position.set(n.x,.9,n.z),r.userData={collected:!1,index:e,baseY:.9,cell:t},Fu.add(r),Gu.push(r)}}function md(){let e=new ln,t=new G(new Bi(.19,.034,12,34),J.brass);t.rotation.x=Math.PI/2,t.castShadow=!0,e.add(t);let n=new G(new li(.035,.035,.55,14),J.brass);n.rotation.z=Math.PI/2,n.position.x=.33,n.castShadow=!0,e.add(n);let r=new G(new oi(.17,.12,.06),J.brass);r.position.set(.6,-.1,0),r.castShadow=!0,e.add(r);let i=new G(new oi(.12,.1,.06),J.brass);i.position.set(.49,-.2,0),i.castShadow=!0,e.add(i);let a=new za(16767597,.32,4.2,2);return e.add(a),e}function hd(){Y.scale.setScalar(.52);let e=new G(new zi(.54,34,22),J.fur);e.scale.set(1.28,.52,.66),e.position.set(0,.4,.05),e.castShadow=!0,Y.add(e);let t=new G(new zi(.46,28,16),J.furDark);t.scale.set(1.08,.32,.52),t.position.set(0,.54,.12),t.castShadow=!0,Y.add(t);let n=new G(new zi(.36,24,14),J.furLight);n.scale.set(.72,.72,.62),n.position.set(0,.43,-.42),n.castShadow=!0,Y.add(n);let r=new G(new zi(.36,34,20),J.furCoffee);r.scale.set(1.02,.9,1.02),r.position.set(0,.86,-.52),r.castShadow=!0,Y.add(r);let i=new G(new zi(.2,22,14),J.furDark);i.scale.set(.74,.76,.2),i.position.set(0,.98,-.81),i.castShadow=!0,Y.add(i);let a=new zi(.15,18,12);for(let e of[-.17,.17]){let t=new G(a,J.muzzle);t.scale.set(.78,.56,.42),t.position.set(e,.76,-.79),t.castShadow=!0,Y.add(t)}let o=new G(new zi(.18,20,12),J.muzzle);o.scale.set(.88,.58,1.08),o.position.set(0,.77,-.94),o.castShadow=!0,Y.add(o);let s=new G(new zi(.058,14,10),J.eye);s.position.set(0,.82,-1.08),Y.add(s);let c=new G(new ui(.034,.14,6),J.tooth);c.position.set(.07,.66,-1.04),c.rotation.set(Math.PI,.08,-.08),Y.add(c);let l=new G(new ui(.13,.48,4,1),J.fur);l.position.set(-.25,1.1,-.5),l.rotation.set(.18,.08,-.42),l.scale.set(.78,1,.48),l.userData.baseRotation=l.rotation.clone(),l.userData.ear=!0,l.castShadow=!0,Y.add(l);let u=l.clone();u.position.x=.25,u.rotation.set(.18,-.08,.42),u.userData.baseRotation=u.rotation.clone(),u.userData.ear=!0,Y.add(u);let d=new zi(.043,12,8);for(let e of[-.12,.12]){let t=new G(d,J.eye);t.position.set(e,.93,-.83),Y.add(t)}let f=new si(.062,.31,6,10);for(let e of[-.32,.32])for(let t of[-.29,.32]){let n=new G(f,t<0?J.muzzle:J.fur);n.position.set(e,.18,t),n.castShadow=!0,Y.add(n);let r=new G(new zi(.078,14,8),J.furLight);r.scale.set(1.18,.42,.92),r.position.set(e,.01,t-.02),r.castShadow=!0,Y.add(r)}let p=new G(new si(.045,.42,6,12),J.fur);p.position.set(0,.66,.58),p.rotation.set(1.05,.1,Math.PI/2),p.userData.baseRotation=p.rotation.clone(),p.userData.wag=!0,p.castShadow=!0,Y.add(p);let m=new ui(.032,.13,6);for(let e=0;e<44;e+=1){let t=new G(m,e%9==0?J.furLight:e%4==0?J.furDark:J.fur),n=ku()*Math.PI*2,r=.23+ku()*.25,i=.34+ku()*.44;t.position.set(Math.cos(n)*r*.98,i,Math.sin(n)*r*.58),t.rotation.set(ku()*Math.PI,ku()*Math.PI,ku()*Math.PI),t.userData.baseRotation=t.rotation.clone(),t.userData.furTuft=!0,t.castShadow=!0,Y.add(t)}let h=new zi(.034,10,8);for(let[e,t,n,r,i,a]of[[-.28,.58,-.18,1.2,.42,.78],[.24,.55,-.03,.88,.38,.68],[-.12,.63,.22,.72,.32,.62],[.36,.4,.24,.7,.3,.54],[-.08,.9,-.86,.54,.32,.26],[.14,.83,-.89,.46,.3,.22],[-.29,.05,-.32,.7,.26,.48],[.31,.05,.31,.62,.24,.42]]){let o=new G(h,J.furLight);o.scale.set(r,i,a),o.position.set(e,t,n),o.castShadow=!0,Y.add(o)}let g=new za(16757611,.13,1.35,1.9);g.position.set(0,.92,-.82),Y.add(g)}function gd(){let e=new Cr({map:yd(),transparent:!0,opacity:0,depthWrite:!1,blending:2});Lu=new G(new Ri(1.42,1.34),e),Lu.visible=!1,Lu.renderOrder=6,xu.add(Lu)}function _d(){if(!tu)return;let e=tu.getContext(`2d`);e&&(e.clearRect(0,0,hu,gu),vd(e,1,0,0))}function vd(e,t=1,n=0,r=0){e.imageSmoothingEnabled=!1;let i=(i,a,o,s,c)=>{e.fillStyle=i,e.fillRect(n+a*t,r+o*t,s*t,c*t)};i(`#8b6c42`,6,10,22,14),i(`#a0845c`,8,11,18,4),i(`#ffffff`,10,18,10,6),i(`#b8944e`,10,2,14,12),i(`#8b6c42`,12,2,10,5),i(`#8b6c42`,10,0,4,5),i(`#8b6c42`,20,0,4,5),i(`#c9a66b`,11,1,2,3),i(`#c9a66b`,21,1,2,3),i(`#111111`,13,6,3,3),i(`#111111`,19,6,3,3),i(`#222222`,14,7,1,1),i(`#222222`,20,7,1,1),i(`#3d2b1f`,16,10,3,2),i(`#ffffff`,17,12,2,2),i(`#a0845c`,4,14,3,8),i(`#a0845c`,27,14,3,8),i(`#b8944e`,8,24,4,6),i(`#b8944e`,22,24,4,6),i(`#ffffff`,8,28,4,2),i(`#ffffff`,22,28,4,2),i(`#8b6c42`,26,8,4,3),i(`#8b6c42`,28,5,3,5),i(`#a0845c`,29,6,2,3)}function yd(){let e=document.createElement(`canvas`);e.width=hu*16,e.height=gu*16;let t=e.getContext(`2d`);t.clearRect(0,0,e.width,e.height),vd(t,16,0,0),t.fillStyle=`rgba(120, 0, 0, 0.08)`,t.fillRect(0,0,e.width,e.height),t.fillStyle=`rgba(255, 255, 255, 0.08)`;for(let n=0;n<e.height;n+=32)t.fillRect(0,n,e.width,1.92);let n=new ni(e);return n.colorSpace=ze,n.magFilter=r,n.minFilter=r,n.generateMipmaps=!1,n}function bd(){let e=new ui(2.2,9,32,1,!0);e.translate(0,-9/2,0);let t=new G(e,new Cr({color:16773320,transparent:!0,opacity:.045,depthWrite:!1,blending:2,side:2,wireframe:!0}));return t.visible=!0,t}function xd(){Bl.addEventListener(`click`,()=>Ad()),Vl.addEventListener(`click`,()=>jd(!0)),window.addEventListener(`keydown`,e=>{e.repeat||(Q.keys.add(e.code),e.code===`KeyF`&&rf(),e.code===`Space`&&Qd())}),window.addEventListener(`keyup`,e=>Q.keys.delete(e.code)),Ll.addEventListener(`click`,()=>{$.state===`playing`&&!Cu&&document.pointerLockElement!==Ll&&Ll.requestPointerLock?.()}),document.addEventListener(`mousemove`,e=>{document.pointerLockElement!==Ll||$.state!==`playing`||(Q.lookX+=e.movementX,Q.lookY+=e.movementY)}),Kl.addEventListener(`pointerdown`,Sd),Kl.addEventListener(`pointermove`,wd),Kl.addEventListener(`pointerup`,Td),Kl.addEventListener(`pointercancel`,Td),Kl.addEventListener(`lostpointercapture`,Td),Yl.addEventListener(`pointerdown`,e=>{e.preventDefault(),e.stopPropagation(),$.scoreEvents.mobileInputSeen=!0,Dd(),Qd()}),Xl.addEventListener(`pointerdown`,e=>{e.preventDefault(),e.stopPropagation(),$.scoreEvents.mobileInputSeen=!0,Dd(),rf()}),window.addEventListener(`resize`,bf),window.addEventListener(`orientationchange`,()=>setTimeout(bf,120)),window.addEventListener(`blur`,Ed),document.addEventListener(`visibilitychange`,()=>{document.hidden&&Ed()})}function Sd(e){e.target.closest(`button`)||$.state===`playing`&&(e.preventDefault(),$.scoreEvents.mobileInputSeen=!0,e.clientX<window.innerWidth*.48&&Q.joystickPointer===null?(Q.joystickPointer=e.pointerId,Cd(e.pointerId),kd(e)):Q.lookPointer===null&&(Q.lookPointer=e.pointerId,Q.lookLast.x=e.clientX,Q.lookLast.y=e.clientY,Cd(e.pointerId)))}function Cd(e){try{Kl.setPointerCapture?.(e)}catch{}}function wd(e){$.state===`playing`&&(e.pointerId===Q.joystickPointer?(e.preventDefault(),kd(e)):e.pointerId===Q.lookPointer&&(e.preventDefault(),Q.lookX+=wf(e.clientX-Q.lookLast.x,-44,44),Q.lookY+=wf(e.clientY-Q.lookLast.y,-44,44),Q.lookLast.x=e.clientX,Q.lookLast.y=e.clientY))}function Td(e){e.pointerId===Q.joystickPointer&&(Q.joystickPointer=null,Q.moveX=0,Q.moveY=0,Jl.style.transform=`translate(-50%, -50%)`),e.pointerId===Q.lookPointer&&(Q.lookPointer=null,Od())}function Ed(){Q.joystickPointer=null,Q.lookPointer=null,Q.moveX=0,Q.moveY=0,Dd(),Jl.style.transform=`translate(-50%, -50%)`}function Dd(){Q.lookX=0,Q.lookY=0,Od()}function Od(){Q.lookLast.x=0,Q.lookLast.y=0}function kd(e){let t=ql.getBoundingClientRect(),n=t.left+t.width/2,r=t.top+t.height/2,i=t.width*.34,a=wf(e.clientX-n,-i,i),o=wf(e.clientY-r,-i,i),s=Math.hypot(a,o),c=s>i?i/s:1,l=a*c,u=o*c;Q.moveX=l/i,Q.moveY=-u/i,Jl.style.transform=`translate(calc(-50% + ${l}px), calc(-50% + ${u}px))`}function Ad(){$.state!==`playing`&&(Ef.unlock(),Rl.classList.add(`hidden`),zl.classList.add(`hidden`),Gl.classList.remove(`hidden`),Kl.classList.remove(`hidden`),ru.classList.remove(`hidden`),$.state=`playing`,of(`The lock needs three keys.`,2.8))}function jd(e){Wu();for(let e of $.sprayParticles)Iu.remove(e),e.geometry.dispose();X.pos.copy(_f(_u.c,_u.r,lu)),X.yaw=-Math.PI/2,X.pitch=0,X.fear=0,X.keys=0,X.bob=0,X.shake=0,X.lastSafe.copy(X.pos),Z.pos.copy(_f(yu.c,yu.r,0)),Z.vel.set(0,0,0),Z.path=[],Z.pathTimer=0,Z.stun=0,Z.retreat=0,Z.barkTimer=1.2,Z.growlTimer=0,Z.biteCooldown=0,Z.flashlightExposure=0,Z.squirtHits=0,Z.flashlightRepels=0,Z.jumpscares=0,Z.vanishes=0,Z.hiddenTimer=0,Z.apparitionTimer=0,Z.apparitionCooldown=0,Z.warpCooldown=7.5,Z.stareTime=0,Z.seenTimer=0,Z.lastDistance=99,Y.position.copy(Z.pos),Y.rotation.set(0,0,0),Y.visible=!0,Lu&&(Lu.visible=!1,Lu.material.opacity=0),$.time=0,$.threat=0,$.messageTimer=0,$.message=``,$.collectedKeys=[],$.sprayParticles=[],$.scoreEvents={keyPickups:0,exitUnlocked:!1,won:!1,dogRepelled:!1,dogVanished:!1,apparitionSeen:!1,jumpscareSeen:!1,mobileInputSeen:!1},Q.flashlightOn=!0,Q.sprayCooldown=0,Q.moveX=0,Q.moveY=0,Q.lookX=0,Q.lookY=0,Q.testMoveX=0,Q.testMoveY=0,Q.testLookX=0,Q.testLookY=0,Q.testUntil=0,Ed(),Q.keys.clear(),Yl.disabled=!1,Yl.style.opacity=`1`,eu.classList.remove(`active`),nu.classList.remove(`active`),Xl.classList.add(`active`),Il.style.setProperty(`--terror`,`0`),Il.style.setProperty(`--danger`,`0`),Il.style.setProperty(`--static-opacity`,`0`);for(let e of Gu)e.visible=!0,e.userData.collected=!1;Ku&&(Ku.rotation.y=Math.PI/2),Ud(),af(),e?(Rl.classList.remove(`hidden`),zl.classList.add(`hidden`),Gl.classList.add(`hidden`),Kl.classList.add(`hidden`),ru.classList.add(`hidden`),$.state=`idle`):($.state=`idle`,ru.classList.add(`hidden`))}function Md(e){$.state===`won`||$.state===`lost`||($.state=e?`won`:`lost`,$.scoreEvents.won=e,$.message=``,$.messageTimer=0,$l.textContent=``,Hl.textContent=e?`Escaped`:`Caught`,Ul.textContent=e?`You made it out.`:`Nighttail found you.`,Wl.textContent=e?`The exit clicks open behind you.`:`The little growl is the last thing in the hall.`,zl.classList.remove(`hidden`),Kl.classList.add(`hidden`),ru.classList.add(`hidden`),e||(Y.visible=!1,Lu&&(Lu.position.set(Z.pos.x,1.02,Z.pos.z),Lu.lookAt(Su.position.x,Lu.position.y,Su.position.z),Lu.material.opacity=.9,Lu.visible=!0)),e&&Ef.win())}function Nd(){requestAnimationFrame(Nd);let e=performance.now(),t=Math.min((e-Ou)/1e3,.04);Ou=e,$.time+=t,lf(t),Pd(t),Eu?Eu.render():wu.render(xu,Su)}function Pd(e){sf(e),$.state===`playing`&&(Fd(e),Id(e),Vd(e)),$.state===`playing`&&Wd(e),$.state===`playing`&&ef(e),$.state===`playing`&&Hd(e),$.state===`playing`&&af(e),nf(e),zd(e),Bd()}function Fd(){let e=Q.lookX+Q.testLookX,t=Q.lookY+Q.testLookY;X.yaw-=e*fu,X.pitch-=t*fu,X.pitch=wf(X.pitch,-1.18,1.05),Q.lookX=0,Q.lookY=0,Q.testLookX=0,Q.testLookY=0}function Id(e){let t=Ld(),n=$.time<=Q.testUntil;n||(Q.testMoveX=0,Q.testMoveY=0);let r=wf(Q.moveX+(n?Q.testMoveX:0)+t.x,-1,1),i=wf(Q.moveY+(n?Q.testMoveY:0)+t.y,-1,1),a=Math.hypot(r,i);a>1&&(r/=a,i/=a);let o=df(),s=new V(-o.z,0,o.x),c=new V().addScaledVector(o,i).addScaledVector(s,r);if(c.lengthSq()>1e-4){c.normalize();let t=du*(1-Math.min(X.fear,70)*.0025)*e;Rd(c.x*t,c.z*t),X.bob+=e*9.2,X.lastSafe.copy(X.pos)}else X.bob+=e*2.4;X.fear=Math.max(0,X.fear-e*2.4)}function Ld(){let e=0,t=0;return(Q.keys.has(`KeyW`)||Q.keys.has(`ArrowUp`))&&(t+=1),(Q.keys.has(`KeyS`)||Q.keys.has(`ArrowDown`))&&--t,(Q.keys.has(`KeyA`)||Q.keys.has(`ArrowLeft`))&&--e,(Q.keys.has(`KeyD`)||Q.keys.has(`ArrowRight`))&&(e+=1),{x:e,y:t}}function Rd(e,t){let n=X.pos.x+e;pf(n,X.pos.z,uu)||(X.pos.x=n);let r=X.pos.z+t;pf(X.pos.x,r,uu)||(X.pos.z=r)}function zd(e){let t=$.state===`playing`?Math.sin(X.bob)*.024:0;X.shake=Math.max(0,X.shake-e*3.2);let n=(ku()-.5)*X.shake*.06,r=(ku()-.5)*X.shake*.06;Su.position.set(X.pos.x,lu+t+r,X.pos.z),Su.rotation.set(X.pitch+n,X.yaw+r*.4,0)}function Bd(){zu.visible=Q.flashlightOn,Bu.visible=Q.flashlightOn;let e=Q.flashlightOn&&!Cu&&window.innerWidth>700;Vu.visible=e,Xl.classList.toggle(`active`,Q.flashlightOn);let t=new V;Su.getWorldDirection(t),zu.position.copy(Su.position),Bu.position.copy(Su.position),zu.target.position.copy(Su.position).addScaledVector(t,12),Vu.position.copy(Su.position).addScaledVector(t,.15),Vu.quaternion.setFromUnitVectors(new V(0,-1,0),t.clone().normalize());let n=.92+Math.sin($.time*17.3)*.035+Math.sin($.time*41.7)*.02;zu.intensity=Q.flashlightOn?78*n:0,Bu.intensity=Q.flashlightOn?.72*n:0,Vu.material.opacity=e?.04+Math.sin($.time*15)*.008:0}function Vd(e){for(let t of Gu)t.userData.collected||(t.rotation.y+=e*1.6,t.position.y=t.userData.baseY+Math.sin($.time*2.6+t.userData.index)*.08,yf(X.pos,t.position)<1.2&&(t.userData.collected=!0,t.visible=!1,X.keys+=1,$.collectedKeys.push(t.userData.index),$.scoreEvents.keyPickups+=1,Ef.pickup(),of(`Key ${X.keys}/${mu}`,1.6),Z.warpCooldown=Math.min(Z.warpCooldown,Math.max(3.4,6.2-X.keys*.65)),Ud()))}function Hd(e){X.keys>=mu&&(Ku.rotation.y=xf(Ku.rotation.y,Math.PI/2-.85,e*1.8),$.scoreEvents.exitUnlocked||($.scoreEvents.exitUnlocked=!0,of(`The exit is open.`,2.2)));let t=_f(vu.c,vu.r,0);yf(X.pos,t)<2.35&&(X.keys>=mu?Md(!0):$.messageTimer<=0&&(of(`Still locked.`,1.6),X.fear=Math.min(100,X.fear+5),Ef.locked()))}function Ud(){if(!Ku)return;let e=X.keys>=mu;Ku.children[0].material=e?J.exitUnlocked:J.exit,qu&&(qu.intensity=e?.85:.45)}function Wd(e){let t=Z.apparitionTimer>0;Z.hiddenTimer=Math.max(0,Z.hiddenTimer-e),Z.apparitionTimer=Math.max(0,Z.apparitionTimer-e),Z.apparitionCooldown=Math.max(0,Z.apparitionCooldown-e),Z.warpCooldown=Math.max(0,Z.warpCooldown-e),Z.stun=Math.max(0,Z.stun-e),Z.retreat=Math.max(0,Z.retreat-e),Z.biteCooldown=Math.max(0,Z.biteCooldown-e),Z.pathTimer-=e;let n=new V(X.pos.x,0,X.pos.z);if(Z.lastDistance=Z.pos.distanceTo(n),t&&Z.apparitionTimer<=0){Xd(`apparition`);return}if(Z.hiddenTimer>0){Y.visible=!1,Z.stareTime=Math.max(0,Z.stareTime-e*1.6),Kd(e),qd(e);return}if(Jd(12.5,.34)){Z.seenTimer+=e,Z.stareTime+=e*(Q.flashlightOn?1.35:.82),$.scoreEvents.apparitionSeen=!0;let t=wf((8.8-Z.lastDistance)/7.4,.2,1);X.fear=Math.min(100,X.fear+e*t*(3.4+X.keys*1.4)),Z.lastDistance<3.35&&Z.apparitionCooldown<=0&&Z.apparitionTimer<=0&&Yd();let n=Math.max(1.85,3.05-X.keys*.18);if(Z.stareTime>n&&Z.biteCooldown<=0){Z.biteCooldown=2.6,Z.jumpscares+=1,$.scoreEvents.jumpscareSeen=!0,X.fear=Math.min(100,X.fear+36),X.shake=Math.max(X.shake,1.15),tf(),Ef.jumpscare(),Xd(`stare`);return}}else Z.seenTimer=Math.max(0,Z.seenTimer-e*1.7),Z.stareTime=Math.max(0,Z.stareTime-e*.85);if(Z.apparitionTimer>0){Y.visible=!1,Kd(e),qd(e),Z.apparitionTimer<=.02&&Xd(`apparition`);return}Y.visible=!0,Z.warpCooldown<=0&&Z.lastDistance>8.5&&Zd(X.keys>=2)&&(Z.warpCooldown=Math.max(3.8,7.8-X.keys*1.2-X.fear*.02));let r=new V,i=Z.pos.clone().sub(n).setY(0);if(i.lengthSq()<.01&&i.set(1,0,0),Z.stun>0||Z.retreat>0)r.copy(i.normalize());else{Z.pathTimer<=0&&(Z.path=mf(vf(Z.pos.x,Z.pos.z),vf(X.pos.x,X.pos.z)),Z.pathTimer=.35);let e=Z.path.length>1?Z.path[1]:vf(X.pos.x,X.pos.z),t=_f(e.c,e.r,0);if(r.copy(t).sub(Z.pos).setY(0),r.lengthSq()<.05&&Z.path.length>2){let e=_f(Z.path[2].c,Z.path[2].r,0);r.copy(e).sub(Z.pos).setY(0)}r.lengthSq()<.01&&r.copy(n).sub(Z.pos).setY(0)}r.lengthSq()>.001&&r.normalize();let a=1+X.keys*.22+X.fear*.005,o=Z.stun>0?.8:Z.retreat>0?1.55:.96*a;if(Gd(r.x*o*e,r.z*o*e),r.lengthSq()>.001){let t=Math.atan2(r.x,r.z);Y.rotation.y=Sf(Y.rotation.y,t,e*7.5)}Y.position.set(Z.pos.x,0,Z.pos.z),Y.position.y=Math.sin($.time*8.5)*.018,Kd(e),qd(e)}function Gd(e,t){let n=Z.pos.x+e;pf(n,Z.pos.z,pu)||(Z.pos.x=n);let r=Z.pos.z+t;pf(Z.pos.x,r,pu)||(Z.pos.z=r)}function Kd(e){if(Z.hiddenTimer>0||Z.apparitionTimer>0)return;let t=Z.lastDistance;Z.barkTimer-=e,Z.growlTimer-=e,t<12&&Z.growlTimer<=0&&(Ef.growl(wf(1-t/12,.08,.9)),Z.growlTimer=1.4+ku()*1.5),t<6.2&&Z.barkTimer<=0&&(Ef.bark(wf(1-t/7,.25,1)),Z.barkTimer=1.1+ku()*1.6)}function qd(e){let t=Z.lastDistance,n=t<2.1||Jd(8,.05);if(t<8&&n&&Z.stun<=0&&Z.hiddenTimer<=0&&(X.fear=Math.min(100,X.fear+e*(8-t)*(.62+X.keys*.13))),t<.68&&Z.biteCooldown<=0&&Z.stun<=0&&Z.retreat<=0&&Z.hiddenTimer<=0){Z.biteCooldown=3.8,Z.jumpscares+=1,$.scoreEvents.jumpscareSeen=!0,X.fear=Math.min(100,X.fear+24),X.shake=Math.max(X.shake,1.4),tf(),Ef.jumpscare();let e=X.pos.clone().sub(Z.pos).setY(0);e.lengthSq()>.001&&(e.normalize().multiplyScalar(.7),Rd(e.x,e.z))}X.fear>=100&&Md(!1)}function Jd(e=12,t=.34){return Z.lastDistance<e&&uf(Z.pos,t)&&ff(X.pos,Z.pos)}function Yd(){Z.apparitionTimer=.95,Z.apparitionCooldown=6.8,Z.stareTime=Math.max(Z.stareTime,.85),Z.path=[],Z.pathTimer=0,$.scoreEvents.apparitionSeen=!0,X.fear=Math.min(100,X.fear+8),X.shake=Math.max(X.shake,.65),of(`The music cuts out.`,1.05),Ef.silence(4.2),Ef.staticDrop()}function Xd(e=`warp`){Z.vanishes+=1,Z.hiddenTimer=e===`spray`?2.9:1.75,Z.apparitionTimer=0,Z.apparitionCooldown=Math.max(Z.apparitionCooldown,5.4),Z.warpCooldown=Math.max(4.2,7.2-X.keys*.9),Z.stun=0,Z.retreat=0,Z.path=[],Z.pathTimer=0,Z.flashlightExposure=0,Z.stareTime=Math.max(0,Z.stareTime-1.2),$.scoreEvents.dogVanished=!0,e!==`stare`&&($.scoreEvents.dogRepelled=!0),Zd(e===`spray`||X.keys>=2),Y.position.copy(Z.pos),Y.visible=!1,Lu&&(Lu.visible=!1,Lu.material.opacity=0),Ef.vanish()}function Zd(e=!1){let t=vf(X.pos.x,X.pos.z),n=[];for(let r=1;r<ou-1;r+=1)for(let i=1;i<su-1;i+=1){if(!hf(i,r))continue;let a=_f(i,r,0),o=yf(X.pos,a);if(o<6||o>17||Math.abs(i-t.c)+Math.abs(r-t.r)<3)continue;let s=uf(a,.18)&&ff(X.pos,a),c=!uf(a,-.1),l=(c?4:0)+(s?-2:1)+ku()*2+(e&&c?3:0);n.push({pos:a,score:l})}if(!n.length)return!1;n.sort((e,t)=>t.score-e.score);let r=n[Math.floor(ku()*Math.min(7,n.length))];return Z.pos.copy(r.pos),Z.lastDistance=yf(X.pos,Z.pos),Y.position.copy(Z.pos),!0}function Qd(){$.state!==`playing`||Q.sprayCooldown>0||(Q.sprayCooldown=.72,X.shake=Math.max(X.shake,.18),Ef.squirt(),$d(),Z.hiddenTimer<=0&&Z.lastDistance<8.6&&uf(Z.pos,.55)&&ff(X.pos,Z.pos)&&(Z.squirtHits+=1,$.scoreEvents.dogRepelled=!0,X.fear=Math.max(0,X.fear-16),of(`Daisy vanishes.`,1.15),Ef.yelpAway(),Xd(`spray`)))}function $d(){let e=new V;Su.getWorldDirection(e);let t=new V(-e.z,0,e.x),n=Su.position.clone().addScaledVector(e,.45).addScaledVector(t,.18);for(let r=0;r<16;r+=1){let r=new G(new zi(.035+ku()*.035,8,6),J.water);r.position.copy(n),r.userData.vel=e.clone().multiplyScalar(7.5+ku()*4).addScaledVector(t,(ku()-.5)*1.1).add(new V(0,(ku()-.2)*.45,0)),r.userData.life=.42+ku()*.18,r.userData.maxLife=r.userData.life,Iu.add(r),$.sprayParticles.push(r)}}function ef(e){Q.sprayCooldown=Math.max(0,Q.sprayCooldown-e),Yl.disabled=Q.sprayCooldown>.02,Yl.style.opacity=Q.sprayCooldown>0?`0.62`:`1`;for(let t=$.sprayParticles.length-1;t>=0;--t){let n=$.sprayParticles[t];n.userData.life-=e,n.userData.vel.y-=e*3.6,n.position.addScaledVector(n.userData.vel,e),n.material.opacity=Math.max(0,.68*(n.userData.life/n.userData.maxLife)),n.userData.life<=0&&(Iu.remove(n),n.geometry.dispose(),$.sprayParticles.splice(t,1))}}function tf(){eu.classList.add(`active`),nu.classList.add(`active`),Uu(()=>eu.classList.remove(`active`),2200),Uu(()=>nu.classList.remove(`active`),620)}function nf(e){let t=$.state===`playing`&&Z.hiddenTimer<=0?wf((8.5-Z.lastDistance)/7.4,0,1):0,n=$.state===`playing`?wf(X.fear/100,0,1):0,r=$.state===`playing`?wf(Z.stareTime/2.2+Z.seenTimer*.28,0,1):0,i=+($.state===`playing`&&Z.apparitionTimer>0),a=Math.max(t,n*.85,r,i);$.threat=xf($.threat,a,wf(e*(i?11:5.5),0,1));let o=$.state===`playing`&&Z.hiddenTimer<=0?Math.max(wf((3.2-Z.lastDistance)/2.8,0,1),r*.65,i):0;Il.style.setProperty(`--terror`,$.threat.toFixed(3)),Il.style.setProperty(`--danger`,o.toFixed(3)),Il.style.setProperty(`--static-opacity`,($.threat*.2+o*.22+r*.12).toFixed(3)),$.state===`playing`&&$.threat>.28&&(X.shake=Math.max(X.shake,$.threat*.34)),Ef.setThreat($.threat,o)}function rf(){$.state===`playing`&&(Q.flashlightOn=!Q.flashlightOn,Ef.click())}function af(e=0){Zl.style.width=`${wf(X.fear,0,100)}%`,Ql.textContent=`Keys ${X.keys}/${mu}`,$.messageTimer>0?($.messageTimer-=e,$l.textContent=$.message):$l.textContent=``}function of(e,t=1.6){$.message=e,$.messageTimer=t}function sf(e){for(let e of Mu.props)e.isPointLight&&(e.intensity=e.userData.baseIntensity*(.84+Math.sin($.time*7+e.userData.flicker)*.08+ku()*.06));for(let e=0;e<Y.children.length;e+=1){let t=Y.children[e];t.geometry?.type===`CapsuleGeometry`&&(t.rotation.x=Math.sin($.time*7+e)*.12),t.userData?.wag&&t.userData.baseRotation&&(t.rotation.copy(t.userData.baseRotation),t.rotation.y+=Math.sin($.time*13)*.34,t.rotation.z+=Math.sin($.time*11)*.16),t.userData?.ear&&t.userData.baseRotation&&(t.rotation.copy(t.userData.baseRotation),t.rotation.x+=Math.sin($.time*5.4+e)*.035),t.userData?.furTuft&&t.userData.baseRotation&&(t.rotation.copy(t.userData.baseRotation),t.rotation.x+=Math.sin($.time*8.5+e*.37)*.035)}Du&&(Du.strength=Cu?.13+X.fear*.001:.19+X.fear*.0012),cf()}function cf(){if(!Lu)return;let e=$.state===`lost`||$.state===`playing`&&Z.apparitionTimer>0;if(Lu.visible=e,!e){Lu.material.opacity=0;return}let t=$.state===`lost`?.9:wf(.35+Z.apparitionTimer*.6,.35,.92);Lu.position.set(Z.pos.x,1+Math.sin($.time*14.5)*.025,Z.pos.z),Lu.lookAt(Su.position.x,Lu.position.y,Su.position.z),Lu.material.opacity=t*(.78+Math.sin($.time*43)*.16)}function lf(e){$.fpsTimer+=e,$.fpsFrames+=1,$.fpsTimer>=.5&&($.fps=Math.round($.fpsFrames/$.fpsTimer),$.fpsTimer=0,$.fpsFrames=0)}function uf(e,t){let n=new V;Su.getWorldDirection(n),n.y=0,n.normalize();let r=new V(e.x-X.pos.x,0,e.z-X.pos.z);return r.lengthSq()<.001?!0:(r.normalize(),n.dot(r)>t)}function df(){let e=new V;return Su.getWorldDirection(e),e.y=0,e.lengthSq()<.001&&e.set(0,0,-1),e.normalize()}function ff(e,t){let n=t.x-e.x,r=t.z-e.z,i=Math.max(2,Math.ceil(Math.hypot(n,r)/(au*.34)));for(let t=1;t<i;t+=1){let a=t/i,o=vf(e.x+n*a,e.z+r*a);if(!hf(o.c,o.r))return!1}return!0}function pf(e,t,n){let r=vf(e,t);for(let i=r.r-1;i<=r.r+1;i+=1)for(let a=r.c-1;a<=r.c+1;a+=1){if(!ju.has(`${a},${i}`))continue;let r={minX:(a-su/2)*au,maxX:(a-su/2+1)*au,minZ:(i-ou/2)*au,maxZ:(i-ou/2+1)*au},o=wf(e,r.minX,r.maxX),s=wf(t,r.minZ,r.maxZ);if(Math.hypot(e-o,t-s)<n)return!0}return!1}function mf(e,t){if(!hf(e.c,e.r)||!hf(t.c,t.r))return[e];let n=[e],r=new Map,i=`${e.c},${e.r}`;r.set(i,null);let a=[{c:1,r:0},{c:-1,r:0},{c:0,r:1},{c:0,r:-1}];for(;n.length;){let e=n.shift();if(e.c===t.c&&e.r===t.r)break;for(let t of a){let i={c:e.c+t.c,r:e.r+t.r},a=`${i.c},${i.r}`;r.has(a)||!hf(i.c,i.r)||(r.set(a,e),n.push(i))}}let o=`${t.c},${t.r}`;if(!r.has(o))return[e];let s=[],c=t;for(;c;)s.push(c),c=r.get(`${c.c},${c.r}`);return s.reverse()}function hf(e,t){return t>=0&&t<ou&&e>=0&&e<su&&Au[t][e]!==`#`}function gf(e,t){return{x:(e-su/2)*au+au/2,z:(t-ou/2)*au+au/2}}function _f(e,t,n=0){let r=gf(e,t);return new V(r.x,n,r.z)}function vf(e,t){return{c:wf(Math.floor(e/au+su/2),0,su-1),r:wf(Math.floor(t/au+ou/2),0,ou-1)}}function yf(e,t){return Math.hypot(e.x-t.x,e.z-t.z)}function bf(){wu.setPixelRatio(Math.min(window.devicePixelRatio||1,Tu)),wu.setSize(window.innerWidth,window.innerHeight,!1),Su.aspect=window.innerWidth/window.innerHeight,Su.updateProjectionMatrix(),Eu&&Eu.setSize(window.innerWidth,window.innerHeight),Du&&Du.setSize(window.innerWidth,window.innerHeight)}function xf(e,t,n){return e+(t-e)*wf(n,0,1)}function Sf(e,t,n){return e+Cf(t-e)*wf(n,0,1)}function Cf(e){return Math.atan2(Math.sin(e),Math.cos(e))}function wf(e,t,n){return Math.max(t,Math.min(n,e))}function Tf(e){return function(){let t=e+=1831565813;return t=Math.imul(t^t>>>15,t|1),t^=t+Math.imul(t^t>>>7,t|61),((t^t>>>14)>>>0)/4294967296}}var Ef={ctx:null,master:null,ambient:null,ambientMuteUntil:0,ambientMuteClockUntil:0,heartbeatTimer:0,unlocked:!1,unlock(){if(this.unlocked)return;let e=window.AudioContext||window.webkitAudioContext;e&&(this.ctx=new e,this.master=this.ctx.createGain(),this.master.gain.value=.58,this.master.connect(this.ctx.destination),this.unlocked=!0,this.startAmbience())},startAmbience(){if(!this.ctx||this.ambient)return;let e=this.ctx.currentTime,t=this.ctx.createOscillator(),n=this.ctx.createOscillator(),r=this.ctx.createOscillator(),i=this.ctx.createGain(),a=this.ctx.createGain(),o=this.ctx.createGain(),s=this.ctx.createGain(),c=this.ctx.createBiquadFilter();t.type=`sawtooth`,n.type=`sine`,r.type=`triangle`,t.frequency.setValueAtTime(42,e),n.frequency.setValueAtTime(29,e),r.frequency.setValueAtTime(229,e),i.gain.value=.018,a.gain.value=.026,o.gain.value=1e-4;let l=Math.floor(this.ctx.sampleRate*2),u=this.ctx.createBuffer(1,l,this.ctx.sampleRate),d=u.getChannelData(0);for(let e=0;e<l;e+=1)d[e]=(Math.random()*2-1)*.34;let f=this.ctx.createBufferSource();f.buffer=u,f.loop=!0,c.type=`bandpass`,c.frequency.value=520,c.Q.value=.55,s.gain.value=.012,t.connect(i),n.connect(a),r.connect(o),f.connect(c),c.connect(s),i.connect(this.master),a.connect(this.master),o.connect(this.master),s.connect(this.master),t.start(e),n.start(e),r.start(e),f.start(e),this.ambient={drone:t,undertone:n,tension:r,droneGain:i,undertoneGain:a,tensionGain:o,noiseGain:s,noiseFilter:c}},setThreat(e=0,t=0){if(!this.ctx||!this.ambient)return;let n=this.ctx.currentTime,r=wf(e,0,1),i=wf(t,0,1),a=this.isSilenced()?.02:1;this.ambient.drone.frequency.setTargetAtTime(38+r*18,n,.18),this.ambient.undertone.frequency.setTargetAtTime(27+i*8,n,.16),this.ambient.tension.frequency.setTargetAtTime(212+r*76+Math.sin($.time*9)*r*7,n,.08),this.ambient.droneGain.gain.setTargetAtTime((.018+r*.032)*a,n,.12),this.ambient.undertoneGain.gain.setTargetAtTime((.026+i*.035)*a,n,.12),this.ambient.tensionGain.gain.setTargetAtTime((1e-4+Math.max(0,r-.2)*.038)*a,n,.1),this.ambient.noiseGain.gain.setTargetAtTime(.012+r*.03+i*.028,n,.08),this.ambient.noiseFilter.frequency.setTargetAtTime(420+r*1500,n,.12),this.heartbeatTimer-=1/60,i>.18&&this.heartbeatTimer<=0&&(this.heartbeatTimer=Math.max(.24,.86-i*.48),this.heartbeat(.25+i*.22))},heartbeat(e=.24){this.tone(`sine`,74,.11,e,-18),Uu(()=>this.tone(`sine`,59,.13,e*.65,-12),145)},tone(e,t,n,r=.14,i=0){if(!this.ctx)return;let a=this.ctx.currentTime,o=this.ctx.createOscillator(),s=this.ctx.createGain();o.type=e,o.frequency.setValueAtTime(t,a),i&&o.frequency.exponentialRampToValueAtTime(Math.max(20,t+i),a+n),s.gain.setValueAtTime(1e-4,a),s.gain.exponentialRampToValueAtTime(r,a+.02),s.gain.exponentialRampToValueAtTime(1e-4,a+n),o.connect(s),s.connect(this.master),o.start(a),o.stop(a+n+.03)},noise(e,t=.08,n=1200){if(!this.ctx)return;let r=Math.max(1,Math.floor(this.ctx.sampleRate*e)),i=this.ctx.createBuffer(1,r,this.ctx.sampleRate),a=i.getChannelData(0);for(let e=0;e<r;e+=1)a[e]=Math.random()*2-1;let o=this.ctx.createBufferSource(),s=this.ctx.createBiquadFilter(),c=this.ctx.createGain();s.type=`bandpass`,s.frequency.value=n,s.Q.value=.9,c.gain.setValueAtTime(t,this.ctx.currentTime),c.gain.exponentialRampToValueAtTime(1e-4,this.ctx.currentTime+e),o.buffer=i,o.connect(s),s.connect(c),c.connect(this.master),o.start(),o.stop(this.ctx.currentTime+e)},growl(e){this.tone(`sawtooth`,58+e*26,.35,.05+e*.08,-12),this.noise(.25,.02+e*.04,180)},bark(e=1){this.tone(`square`,340+e*90,.095,.09+e*.08,-150),Uu(()=>this.tone(`square`,270,.08,.06,-90),78)},jumpscare(){this.noise(.42,.34,650),this.tone(`sawtooth`,90,.48,.24,-40),this.bark(1)},squirt(){this.noise(.18,.12,1850)},yelpAway(){this.tone(`sine`,540,.17,.08,180)},silence(e=1.2){this.ambientMuteClockUntil=Math.max(this.ambientMuteClockUntil,performance.now()/1e3+e),this.ctx&&(this.ambientMuteUntil=Math.max(this.ambientMuteUntil,this.ctx.currentTime+e))},isSilenced(){return performance.now()/1e3<this.ambientMuteClockUntil||!!(this.ctx&&this.ambientMuteUntil>this.ctx.currentTime)},staticDrop(){this.noise(.34,.22,520),this.tone(`triangle`,180,.18,.08,-120)},vanish(){this.noise(.2,.12,1500),this.tone(`sine`,680,.1,.055,-340)},pickup(){this.tone(`triangle`,700,.12,.08,260),Uu(()=>this.tone(`triangle`,960,.12,.06,90),90)},locked(){this.tone(`square`,120,.14,.08,-30)},click(){this.tone(`square`,920,.035,.035,-200)},win(){this.tone(`triangle`,440,.18,.08,220),Uu(()=>this.tone(`triangle`,660,.22,.08,160),160),Uu(()=>this.tone(`triangle`,980,.28,.07,100),340)}};Nd(),iu&&(window.__NIGHTTAIL_TEST__={start(){Ad()},reset(){jd(!1),Ad()},setInput(e){Q.testMoveX=wf(e.moveX??0,-1,1),Q.testMoveY=wf(e.moveY??0,-1,1),Q.testLookX=wf(e.lookX??0,-90,90),Q.testLookY=wf(e.lookY??0,-60,60),Q.testUntil=$.time+wf(e.hold??.28,.04,.5)},fire(){Qd()},placeDogForOrganicBiteTest(){let e=new V(X.pos.x,0,X.pos.z);Q.flashlightOn=!1,Z.pos.copy(e).addScaledVector(df(),.48),Z.vel.set(0,0,0),Z.path=[],Z.pathTimer=0,Z.stun=0,Z.retreat=0,Z.biteCooldown=0,Z.hiddenTimer=0,Z.apparitionTimer=0,Z.apparitionCooldown=8,Z.lastDistance=yf(X.pos,Z.pos),Y.position.copy(Z.pos),X.fear=Math.min(X.fear,20)},placeDogForOrganicApparitionTest(e=2.15){let t=new V(X.pos.x,0,X.pos.z);Z.pos.copy(t).addScaledVector(df(),wf(e,1.2,4.2)),Z.vel.set(0,0,0),Z.path=[],Z.pathTimer=0,Z.stun=0,Z.retreat=0,Z.biteCooldown=1.2,Z.flashlightExposure=0,Z.hiddenTimer=0,Z.apparitionCooldown=0,Z.lastDistance=yf(X.pos,Z.pos),Y.position.copy(Z.pos),Y.lookAt(X.pos.x,Y.position.y,X.pos.z),X.fear=Math.max(X.fear,34)},forceLoseTest(){X.fear=100,Md(!1)},setFlashlight(e){Q.flashlightOn=!!e},snapshot(){return{state:$.state,player:{x:X.pos.x,z:X.pos.z,yaw:X.yaw,pitch:X.pitch,fear:X.fear,keys:X.keys},dog:{x:Z.pos.x,z:Z.pos.z,distance:Z.lastDistance,stun:Z.stun,retreat:Z.retreat,hiddenTimer:Z.hiddenTimer,apparitionTimer:Z.apparitionTimer,apparitionVisible:!!Lu?.visible,squirtHits:Z.squirtHits,flashlightRepels:Z.flashlightRepels,jumpscares:Z.jumpscares,vanishes:Z.vanishes,stareTime:Z.stareTime,radius:pu,visualScale:Y.scale.x,meshVisible:Y.visible},effects:{threat:$.threat,staticOpacity:Number(getComputedStyle(Il).getPropertyValue(`--static-opacity`))||0,danger:Number(getComputedStyle(Il).getPropertyValue(`--danger`))||0},audio:{unlocked:Ef.unlocked,ambientActive:!!Ef.ambient,ambientMuted:Ef.isSilenced()},keys:Gu.map(e=>({index:e.userData.index,collected:e.userData.collected,x:e.position.x,z:e.position.z,cell:e.userData.cell})),exit:{x:gf(vu.c,vu.r).x,z:gf(vu.c,vu.r).z,cell:vu,unlocked:X.keys>=mu},grid:Au.map(e=>e.join(``)),cellSize:au,rows:ou,cols:su,fps:$.fps,events:{...$.scoreEvents},mobileUi:{joystick:!!ql.offsetWidth,sprayButton:!!Yl.offsetWidth,flashlightButton:!!Xl.offsetWidth,weaponView:!!ru.offsetWidth}}},cellToWorld(e,t){return gf(e,t)},pathToCell(e){return mf(vf(X.pos.x,X.pos.z),e).map(e=>({...e,...gf(e.c,e.r)}))}});
//# sourceMappingURL=index-D1Dq_dNo.js.map