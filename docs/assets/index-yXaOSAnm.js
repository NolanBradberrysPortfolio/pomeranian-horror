	...
	if ( coord.x >= 1.0 ) {
		...
		void main() {
			...
			gl_FragColor = mix( outputColor, texel, alpha );
				...
				}`})}};Fl.BlurDirectionX=new B(1,0),Fl.BlurDirectionY=new B(0,1);var Il=document.querySelector(`#app`),Ll=document.querySelector(`#game-canvas`),Rl=document.querySelector(`#start-screen`),zl=document.querySelector(`#result-screen`),Bl=document.querySelector(`#start-button`),Vl=document.querySelector(`#restart-button`),Hl=document.querySelector(`#result-kicker`),Ul=document.querySelector(`#result-title`),Wl=document.querySelector(`#result-copy`),Gl=document.querySelector(`#hud`),Kl=document.querySelector(`#touch-layer`),ql=document.querySelector(`#joystick`),Jl=document.querySelector(`#joystick span`),Yl=document.querySelector(`#spray-button`),Xl=document.querySelector(`#flashlight-button`),Zl=document.querySelector(`#fear-fill`),Ql=document.querySelector(`#key-counter`),$l=document.querySelector(`#message-feed`),eu=document.querySelector(`#jumpscare`),tu=document.querySelector(`#blood-flash`),nu=new URLSearchParams(window.location.search).has(`test`)&&/^(localhost|127\.0\.0\.1|\[::1\])$/.test(window.location.hostname),ru=3,iu=17,au=25,ou=3.4,su=1.62,cu=.42,lu=3.05,uu=.0031,du=.22,fu=3,pu={c:1,r:1},mu={c:23,r:1},hu={c:2,r:14},gu=[{c:10,r:2},{c:3,r:8},{c:21,r:14}],_u=new vn;_u.background=new W(263686),_u.fog=new _n(197893,.02);var vu=new Fa(73,window.innerWidth/window.innerHeight,.03,85);vu.rotation.order=`YXZ`;var yu=matchMedia(`(pointer: coarse)`).matches||/Android|iPhone|iPad|iPod/i.test(navigator.userAgent),bu=new Cl({canvas:Ll,antialias:!yu,powerPreference:`high-performance`});bu.shadowMap.enabled=!yu,bu.shadowMap.type=1,bu.outputColorSpace=ze,bu.toneMapping=4,bu.toneMappingExposure=1.05;var xu=yu?1.25:1.85;bu.setPixelRatio(Math.min(window.devicePixelRatio||1,xu)),bu.setSize(window.innerWidth,window.innerHeight,!1);var Su=null,Cu=null;try{yu||(Su=new Ml(bu),Su.addPass(new Nl(_u,vu)),Cu=new Fl(new B(window.innerWidth,window.innerHeight),.22,.35,.72),Su.addPass(Cu))}catch{Su=null}var wu=performance.now(),Tu=ff(3713),Eu=Wu(),Du=new Set,Ou={walls:[],props:[],width:au*ru,depth:iu*ru},J=Ku(),ku=new ln,Au=new ln,ju=new ln,Mu=new ln,Y=new ln;_u.add(ku,Au,ju,Mu,Y);var Nu=null,Pu=new Ca(13950927,526085,.31);_u.add(Pu);var Fu=new La(16774350,78,28,Math.PI/6.3,.58,1.42);Fu.castShadow=!yu,Fu.shadow.mapSize.set(yu?512:1024,yu?512:1024),Fu.shadow.camera.near=.15,Fu.shadow.camera.far=22,Fu.target.position.set(0,0,-1),_u.add(Fu,Fu.target);var Iu=new za(16772553,.72,7.5,1.35);_u.add(Iu);var Lu=md();_u.add(Lu);var X={pos:new V,yaw:-Math.PI/2,pitch:0,fear:0,keys:0,bob:0,shake:0,lastSafe:new V},Z={pos:new V,vel:new V,path:[],pathTimer:0,stun:0,retreat:0,barkTimer:1.2,growlTimer:0,biteCooldown:0,flashlightExposure:0,squirtHits:0,flashlightRepels:0,jumpscares:0,lastDistance:99},Q={moveX:0,moveY:0,lookX:0,lookY:0,testMoveX:0,testMoveY:0,testLookX:0,testLookY:0,testUntil:0,keys:new Set,flashlightOn:!0,sprayCooldown:0,joystickPointer:null,lookPointer:null,lookLast:{x:0,y:0}},$={state:`idle`,time:0,messageTimer:0,message:``,collectedKeys:[],sprayParticles:[],fps:60,fpsTimer:0,fpsFrames:0,threat:0,scoreEvents:{keyPickups:0,exitUnlocked:!1,won:!1,dogRepelled:!1,jumpscareSeen:!1,mobileInputSeen:!1}},Ru=new Set;function zu(e,t){let n=window.setTimeout(()=>{Ru.delete(n),e()},t);return Ru.add(n),n}function Bu(){for(let e of Ru)window.clearTimeout(e);Ru.clear()}var Vu=[],Hu=null,Uu=null;Gu(),cd(),ud(),fd(),pd(),Sd(!1),hd();function Wu(){let e=Array.from({length:iu},()=>Array.from({length:au},()=>`.`));for(let t=0;t<iu;t+=1)e[t][0]=`#`,e[t][au-1]=`#`;for(let t=0;t<au;t+=1)e[0][t]=`#`,e[iu-1][t]=`#`;let t=(t,n,r,i=[])=>{for(let a=n;a<=r;a+=1)i.includes(a)||(e[a][t]=`#`)},n=(t,n,r,i=[])=>{for(let a=n;a<=r;a+=1)i.includes(a)||(e[t][a]=`#`)};t(6,1,15,[4,10,14]),t(13,1,15,[5,11,15]),t(19,3,15,[8,13]),n(5,1,23,[3,10,16,22]),n(10,1,23,[4,8,15,22]),n(13,6,23,[11,18,21]),t(3,10,15,[12]),t(22,5,12,[7,10]),((t,n,r)=>{for(let i=n;i<=r;i+=1)e[t][i]=`.`})(8,3,21),((t,n,r)=>{for(let i=n;i<=r;i+=1)e[i][t]=`.`})(21,8,14);let r=[pu,mu,hu,...gu];for(let t of r)e[t.r][t.c]=`.`;return e}function Gu(){J.floor.map.repeat.set(au/2.2,iu/2.2);let e=new G(new Ri(au*ru,iu*ru,au,iu),J.floor);e.rotation.x=-Math.PI/2,e.receiveShadow=!0,_u.add(e);let t=new G(new Ri(au*ru,iu*ru),J.ceiling);t.position.y=ou,t.rotation.x=Math.PI/2,t.receiveShadow=!0,_u.add(t);let n=Eu.flat().filter(e=>e===`#`).length,r=new Kr(new oi(ru,ou,ru),J.wall,n);r.castShadow=!0,r.receiveShadow=!0;let i=new Pt,a=0;for(let e=0;e<iu;e+=1)for(let t=0;t<au;t+=1){if(Eu[e][t]!==`#`)continue;let n=nf(t,e);i.compose(new V(n.x,ou/2,n.z),new ft,new V(1,1+Tu()*.04,1)),r.setMatrixAt(a,i),Du.add(`${t},${e}`),Ou.walls.push({c:t,r:e,minX:n.x-ru/2,maxX:n.x+ru/2,minZ:n.z-ru/2,maxZ:n.z+ru/2}),a+=1}r.instanceMatrix.needsUpdate=!0,ku.add(r),Xu(),Zu(),Qu()}function Ku(){let t=qu(`abandoned-wall.png`),n=qu(`abandoned-floor.png`),r=Ju(512);for(let i of[t,n,r])i.wrapS=e,i.wrapT=e,i.colorSpace=ze,i.anisotropy=Math.min(8,bu.capabilities.getMaxAnisotropy());return{wall:new Qi({map:t,color:8553074,roughness:.94,metalness:.02,bumpMap:t,bumpScale:.06}),floor:new Qi({map:n,color:7106919,roughness:.88,metalness:.08,bumpMap:n,bumpScale:.04}),ceiling:new Qi({map:r,color:3487541,roughness:.98,metalness:.01}),trim:new Qi({color:3093293,roughness:.72,metalness:.28}),brass:new Qi({color:14202963,roughness:.32,metalness:.85,emissive:3810565,emissiveIntensity:.22}),exit:new Qi({color:2634278,roughness:.7,metalness:.1}),exitUnlocked:new Qi({color:5335878,roughness:.55,metalness:.14,emissive:2375451,emissiveIntensity:.35}),darkMetal:new Qi({color:1580062,roughness:.52,metalness:.78}),crate:new Qi({color:6705467,roughness:.86,metalness:.02}),paper:new Qi({color:13222312,roughness:.93,metalness:.01}),fabric:new Qi({color:3490364,roughness:.97,metalness:0}),stain:new Cr({color:1641737,transparent:!0,opacity:.56,depthWrite:!1}),wire:new Qi({color:394758,roughness:.55,metalness:.5}),warning:new Qi({color:8350500,roughness:.74,metalness:.18,emissive:1905155,emissiveIntensity:.12}),wet:new Qi({color:1713446,roughness:.38,metalness:.05,transparent:!0,opacity:.62}),fur:new Qi({color:5976863,roughness:.98,metalness:0}),furDark:new Qi({color:2758157,roughness:.98,metalness:0}),furLight:new Qi({color:15259583,roughness:.95,metalness:0}),furCoffee:new Qi({color:11039557,roughness:.96,metalness:0}),muzzle:new Qi({color:14270113,roughness:.92,metalness:0}),eye:new Qi({color:853764,roughness:.36,metalness:0,emissive:16761707,emissiveIntensity:.08}),water:new Qi({color:10217727,roughness:.2,metalness:0,transparent:!0,opacity:.68,emissive:1525850,emissiveIntensity:.3})}}function qu(t){let n=new xa().load(`/pomeranian-horror/assets/${t}`);return n.wrapS=e,n.wrapT=e,n.colorSpace=ze,n.anisotropy=Math.min(8,bu.capabilities.getMaxAnisotropy()),n}function Ju(e){return Yu(e,(e,t,n)=>{e.fillStyle=`#303331`,e.fillRect(0,0,t,t);for(let r=0;r<2400;r+=1){let r=Math.floor(28+n()*55);e.fillStyle=`rgba(${r},${r+2},${r},${.08+n()*.09})`,e.fillRect(n()*t,n()*t,1+n()*3,1+n()*3)}for(let r=0;r<18;r+=1)e.fillStyle=`rgba(0, 0, 0, ${.18+n()*.24})`,e.fillRect(n()*t,n()*t,20+n()*90,4+n()*14)})}function Yu(e,t){let n=document.createElement(`canvas`);n.width=e,n.height=e,t(n.getContext(`2d`),e,ff(e*17+53));let r=new ni(n);return r.needsUpdate=!0,r}function Xu(){let e=[{c:3,r:2,color:16771258,intensity:.34},{c:10,r:3,color:12576511,intensity:.26},{c:16,r:7,color:16766881,intensity:.21},{c:4,r:12,color:12124113,intensity:.19},{c:21,r:14,color:16769966,intensity:.3},{c:22,r:1,color:14417865,intensity:.42}],t=new li(.42,.42,.08,20);for(let n of e){let e=nf(n.c,n.r),r=new G(t,J.darkMetal);r.position.set(e.x,ou-.08,e.z),r.castShadow=!0,Au.add(r);let i=new za(n.color,n.intensity,11,1.6);i.position.set(e.x,ou-.3,e.z),i.castShadow=!yu&&n.intensity>.28,i.userData.baseIntensity=n.intensity,i.userData.flicker=Tu()*20,Au.add(i),Ou.props.push(i)}}function Zu(){let e=J.trim,t=new oi(ru*.88,.14,.12),n=new oi(.12,1.85,.12);for(let r of[{c:6,r:4,axis:`z`},{c:6,r:10,axis:`z`},{c:13,r:5,axis:`z`},{c:13,r:11,axis:`z`},{c:19,r:8,axis:`z`},{c:3,r:5,axis:`x`},{c:10,r:5,axis:`x`},{c:15,r:10,axis:`x`},{c:18,r:13,axis:`x`}]){let i=nf(r.c,r.r),a=new G(t,e);a.position.set(i.x,2.12,i.z),r.axis===`x`&&(a.rotation.y=Math.PI/2),a.castShadow=!0,Au.add(a);let o=r.axis===`x`?[new V(0,0,-3*.42),new V(0,0,ru*.42)]:[new V(-3*.42,0,0),new V(ru*.42,0,0)];for(let t of o){let r=new G(n,e);r.position.set(i.x+t.x,1.02,i.z+t.z),r.castShadow=!0,Au.add(r)}}}function Qu(){let e=new oi(.85,.65,.85),t=new li(.06,.06,1.4,12),n=new ci(.7,24),r=new Cr({map:od(256),transparent:!0,opacity:.78});for(let r=1;r<iu-1;r+=1)for(let i=1;i<au-1;i+=1){if(!tf(i,r)||sd(i,r))continue;let a=Tu(),o=nf(i,r);if(a<.055){let t=new G(e,J.crate);t.position.set(o.x+(Tu()-.5)*1.2,.33,o.z+(Tu()-.5)*1.2),t.rotation.y=Tu()*Math.PI,t.scale.setScalar(.75+Tu()*.7),t.castShadow=!0,t.receiveShadow=!0,Au.add(t)}else if(a<.095){let e=new G(t,J.darkMetal);e.position.set(o.x+(Tu()-.5)*1.4,.11,o.z+(Tu()-.5)*1.4),e.rotation.z=Math.PI/2,e.rotation.y=Tu()*Math.PI,e.castShadow=!0,Au.add(e)}else if(a<.135){let e=new G(n,J.wet);e.position.set(o.x+(Tu()-.5)*1.3,.012,o.z+(Tu()-.5)*1.3),e.rotation.x=-Math.PI/2,e.scale.set(.7+Tu()*1.4,.34+Tu()*.7,1),Au.add(e)}}let i=[{c:2,r:4,rot:0},{c:11,r:1,rot:Math.PI},{c:18,r:9,rot:-Math.PI/2},{c:8,r:15,rot:Math.PI}];for(let e of i){let t=nf(e.c,e.r),n=new G(new Ri(1.05,1.45),r);n.position.set(t.x,1.72,t.z),n.rotation.y=e.rot,n.translateZ(-3*.48),Au.add(n)}$u(),rd()}function $u(){let e=new oi(1,1,1),t=new oi(1.65,.12,.16),n=new oi(1.45,.18,2.1),r=new oi(.62,.08,.58),i=new oi(.62,.72,.08),a=new li(.035,.035,.58,8),o=new ci(.72,24),s=[{c:5,r:2,rot:.1},{c:15,r:4,rot:Math.PI*.52},{c:22,r:9,rot:-.35}];for(let t of s){let n=nf(t.c,t.r);ed(e,J.darkMetal,n.x,.74,n.z,.92,1.48,.48,t.rot),ed(e,J.paper,n.x+Math.cos(t.rot)*.05,1.16,n.z+Math.sin(t.rot)*.05,.72,.06,.07,t.rot)}for(let t of[{c:10,r:4,rot:-.25},{c:4,r:11,rot:.55},{c:20,r:14,rot:-.5}]){let r=nf(t.c,t.r);ed(n,J.fabric,r.x-.35,.13,r.z+.18,1,1,1,t.rot),ed(e,J.paper,r.x+.55,.25,r.z-.55,.78,.08,.48,t.rot+.2),td(o,r.x+.2,r.z+.7,1.1,.46,t.rot+.1)}for(let e of[{c:8,r:8,rot:.8},{c:17,r:6,rot:-.55},{c:14,r:12,rot:2.2},{c:21,r:3,rot:-1.1}]){let t=nf(e.c,e.r);ed(r,J.crate,t.x,.42,t.z,1,1,1,e.rot),ed(i,J.crate,t.x-Math.sin(e.rot)*.32,.78,t.z-Math.cos(e.rot)*.32,1,1,1,e.rot);for(let n of[-.24,.24])for(let r of[-.2,.2]){let i=new G(a,J.darkMetal);i.position.set(t.x+Math.cos(e.rot)*n-Math.sin(e.rot)*r,.2,t.z+Math.sin(e.rot)*n+Math.cos(e.rot)*r),i.rotation.z=(Tu()-.5)*.22,i.castShadow=!0,Au.add(i)}}let c=[{c:2,r:6,rot:0},{c:12,r:15,rot:Math.PI},{c:19,r:2,rot:Math.PI},{c:23,r:12,rot:-Math.PI/2}];for(let e of c){let n=nf(e.c,e.r);for(let r=0;r<3;r+=1){let i=new G(t,J.crate);i.position.set(n.x,1.12+r*.29,n.z),i.rotation.y=e.rot+(r-1)*.08,i.translateZ(-3*.49),i.castShadow=!0,Au.add(i)}}nd(6,12,9,12),nd(16,10,16,13),nd(21,5,23,5)}function ed(e,t,n,r,i,a,o,s,c=0){let l=new G(e,t);return l.position.set(n,r,i),l.scale.set(a,o,s),l.rotation.y=c,l.castShadow=!0,l.receiveShadow=!0,Au.add(l),l}function td(e,t,n,r,i,a){let o=new G(e,J.stain);o.position.set(t,.018,n),o.rotation.x=-Math.PI/2,o.rotation.z=a,o.scale.set(r,i,1),Au.add(o)}function nd(e,t,n,r){let i=nf(e,t),a=nf(n,r),o=new G(new Vi(new bi([new V(i.x,ou-.18,i.z),new V((i.x+a.x)/2,ou-.78,(i.z+a.z)/2),new V(a.x,ou-.28,a.z)]),12,.025,8),J.wire);o.castShadow=!0,Au.add(o)}function rd(){let e=new Cr({map:id(256),transparent:!0,opacity:.86}),t=new Cr({map:ad(256),transparent:!0,opacity:.52,depthWrite:!1}),n=[{c:1,r:1,rot:Math.PI/2,mat:e,w:1.18,h:.72},{c:1,r:2,rot:Math.PI/2,mat:t,w:1.65,h:1.18},{c:5,r:5,rot:0,mat:e,w:1.2,h:.72},{c:17,r:10,rot:Math.PI,mat:e,w:1.2,h:.72},{c:7,r:14,rot:Math.PI,mat:t,w:1.7,h:1.25},{c:20,r:8,rot:-Math.PI/2,mat:t,w:1.6,h:1.1},{c:3,r:13,rot:Math.PI/2,mat:t,w:1.55,h:1.25}];for(let e of n){let t=nf(e.c,e.r),n=new G(new Ri(e.w,e.h),e.mat);n.position.set(t.x,1.55,t.z),n.rotation.y=e.rot,n.translateZ(-3*.49),Au.add(n)}}function id(e){return Yu(e,(e,t)=>{e.fillStyle=`#6e5f28`,e.fillRect(0,0,t,t),e.strokeStyle=`#1a1308`,e.lineWidth=12,e.strokeRect(10,10,t-20,t-20),e.fillStyle=`#1a1308`,e.font=`bold 44px Arial`,e.textAlign=`center`,e.fillText(`KEEP`,t/2,88),e.fillText(`QUIET`,t/2,145),e.fillRect(52,178,t-104,14)})}function ad(e){return Yu(e,(e,t,n)=>{e.clearRect(0,0,t,t),e.strokeStyle=`rgba(5, 6, 5, 0.82)`;for(let r=0;r<36;r+=1){e.lineWidth=1+n()*3,e.beginPath();let r=20+n()*(t-40),i=20+n()*(t-40);e.moveTo(r,i),e.lineTo(r+(n()-.5)*96,i+38+n()*70),e.stroke()}})}function od(e){return Yu(e,(e,t,n)=>{e.fillStyle=`rgba(210, 198, 152, 0.86)`,e.fillRect(0,0,t,t),e.fillStyle=`rgba(38, 49, 40, 0.75)`,e.fillRect(22,24,t-44,28),e.fillRect(22,73,t-70,9),e.fillRect(22,96,t-54,9),e.fillStyle=`rgba(76, 26, 20, 0.42)`;for(let r=0;r<18;r+=1)e.beginPath(),e.arc(n()*t,n()*t,5+n()*34,0,Math.PI*2),e.fill()})}function sd(e,t){return[pu,mu,hu,...gu].some(n=>Math.abs(n.c-e)<=1&&Math.abs(n.r-t)<=1)}function cd(){let e=nf(mu.c,mu.r),t=new ln,n=new G(new oi(1.65,2.6,.22),J.exit);n.position.set(0,1.3,-1.05),n.castShadow=!0,n.receiveShadow=!0,t.add(n);let r=new G(new zi(.11,16,12),J.brass);r.position.set(-.52,1.22,-.91),r.castShadow=!0,t.add(r);let i=ld(256),a=new G(new Ri(1.25,.44),new Cr({map:i,transparent:!0}));a.position.set(0,2.82,-.88),t.add(a),Uu=new za(12255119,.45,5.5,1.2),Uu.position.set(0,2.62,-.7),t.add(Uu),t.position.set(e.x,0,e.z),t.rotation.y=Math.PI/2,Hu=t,_u.add(t)}function ld(e){return Yu(e,(e,t)=>{e.fillStyle=`#18261d`,e.fillRect(0,0,t,t),e.fillStyle=`#bdf2a6`,e.fillRect(8,8,t-16,t-16),e.fillStyle=`#163018`,e.font=`bold 96px Arial`,e.textAlign=`center`,e.textBaseline=`middle`,e.fillText(`EXIT`,t/2,t/2+6)})}function ud(){for(let e=0;e<gu.length;e+=1){let t=gu[e],n=nf(t.c,t.r),r=dd();r.position.set(n.x,.9,n.z),r.userData={collected:!1,index:e,baseY:.9,cell:t},ju.add(r),Vu.push(r)}}function dd(){let e=new ln,t=new G(new Bi(.19,.034,12,34),J.brass);t.rotation.x=Math.PI/2,t.castShadow=!0,e.add(t);let n=new G(new li(.035,.035,.55,14),J.brass);n.rotation.z=Math.PI/2,n.position.x=.33,n.castShadow=!0,e.add(n);let r=new G(new oi(.17,.12,.06),J.brass);r.position.set(.6,-.1,0),r.castShadow=!0,e.add(r);let i=new G(new oi(.12,.1,.06),J.brass);i.position.set(.49,-.2,0),i.castShadow=!0,e.add(i);let a=new za(16767597,.32,4.2,2);return e.add(a),e}function fd(){Y.scale.setScalar(.56);let e=new G(new zi(.56,34,22),J.fur);e.scale.set(1.22,.58,.76),e.position.set(0,.43,0),e.castShadow=!0,Y.add(e);let t=new G(new zi(.48,28,16),J.furDark);t.scale.set(1.12,.38,.52),t.position.set(0,.58,.08),t.castShadow=!0,Y.add(t);let n=new G(new zi(.42,28,16),J.furLight);n.scale.set(.9,.78,.7),n.position.set(0,.46,-.46),n.castShadow=!0,Y.add(n);let r=new G(new zi(.38,34,20),J.furCoffee);r.scale.set(1.05,.92,.98),r.position.set(0,.88,-.55),r.castShadow=!0,Y.add(r);let i=new G(new zi(.18,18,12),J.furLight);i.scale.set(.42,1.06,.2),i.position.set(0,.91,-.88),i.castShadow=!0,Y.add(i);let a=new zi(.16,18,12);for(let e of[-.18,.18]){let t=new G(a,J.furLight);t.scale.set(.75,.58,.38),t.position.set(e,.78,-.86),t.castShadow=!0,Y.add(t)}let o=new G(new zi(.2,20,12),J.muzzle);o.scale.set(.85,.6,1.1),o.position.set(0,.8,-.9),o.castShadow=!0,Y.add(o);let s=new G(new zi(.062,14,10),J.eye);s.position.set(0,.83,-1.08),Y.add(s);let c=new G(new ui(.16,.38,18),J.furDark);c.position.set(-.23,1.15,-.54),c.rotation.set(.2,.4,.3),c.userData.baseRotation=c.rotation.clone(),c.userData.ear=!0,c.castShadow=!0,Y.add(c);let l=c.clone();l.position.x=.23,l.rotation.z=-.3,l.userData.baseRotation=l.rotation.clone(),l.userData.ear=!0,Y.add(l);let u=new zi(.045,12,8);for(let e of[-.13,.13]){let t=new G(u,J.eye);t.position.set(e,.94,-.88),Y.add(t)}let d=new si(.07,.35,6,10);for(let e of[-.33,.33])for(let t of[-.3,.32]){let n=new G(d,t<0?J.furLight:J.fur);n.position.set(e,.2,t),n.castShadow=!0,Y.add(n);let r=new G(new zi(.08,14,8),J.furLight);r.scale.set(1.2,.45,.95),r.position.set(e,.02,t-.02),r.castShadow=!0,Y.add(r)}let f=new G(new Bi(.25,.06,12,28,Math.PI*1.48),J.furLight);f.position.set(0,.72,.55),f.rotation.set(.8,.08,Math.PI/2),f.userData.baseRotation=f.rotation.clone(),f.userData.wag=!0,f.castShadow=!0,Y.add(f);let p=new ui(.05,.22,7);for(let e=0;e<22;e+=1){let t=e/22*Math.PI*2,n=new G(p,J.furLight);n.position.set(Math.cos(t)*.3,.69+Math.sin(t*2)*.03,-.47+Math.sin(t)*.12),n.rotation.set(Math.PI/2+Tu()*.4,t,Tu()*Math.PI),n.castShadow=!0,Y.add(n)}let m=new ui(.043,.17,7);for(let e=0;e<94;e+=1){let t=new G(m,e%5==0?J.furLight:e%4==0?J.furDark:e%3==0?J.furCoffee:J.fur),n=Tu()*Math.PI*2,r=.28+Tu()*.26,i=.38+Tu()*.48;t.position.set(Math.cos(n)*r*.92,i,Math.sin(n)*r*.68),t.rotation.set(Tu()*Math.PI,Tu()*Math.PI,Tu()*Math.PI),t.userData.baseRotation=t.rotation.clone(),t.userData.furTuft=!0,t.castShadow=!0,Y.add(t)}let h=new za(16757611,.16,1.5,1.9);h.position.set(0,.92,-.82),Y.add(h)}function pd(){let e=new xa().load(`/pomeranian-horror/assets/nighttail-jumpscare.png`);e.colorSpace=ze,e.anisotropy=Math.min(8,bu.capabilities.getMaxAnisotropy());let t=new Cr({map:e,transparent:!0,opacity:0,depthWrite:!1});Nu=new G(new Ri(1.28,2.22),t),Nu.visible=!1,Nu.renderOrder=6,_u.add(Nu)}function md(){let e=new ui(2.2,9,32,1,!0);e.translate(0,-9/2,0);let t=new G(e,new Cr({color:16773320,transparent:!0,opacity:.045,depthWrite:!1,blending:2,side:2,wireframe:!0}));return t.visible=!0,t}function hd(){Bl.addEventListener(`click`,()=>xd()),Vl.addEventListener(`click`,()=>Sd(!0)),window.addEventListener(`keydown`,e=>{e.repeat||(Q.keys.add(e.code),e.code===`KeyF`&&Wd(),e.code===`Space`&&zd())}),window.addEventListener(`keyup`,e=>Q.keys.delete(e.code)),Ll.addEventListener(`click`,()=>{$.state===`playing`&&!yu&&document.pointerLockElement!==Ll&&Ll.requestPointerLock?.()}),document.addEventListener(`mousemove`,e=>{document.pointerLockElement!==Ll||$.state!==`playing`||(Q.lookX+=e.movementX,Q.lookY+=e.movementY)}),Kl.addEventListener(`pointerdown`,gd),Kl.addEventListener(`pointermove`,vd),Kl.addEventListener(`pointerup`,yd),Kl.addEventListener(`pointercancel`,yd),Yl.addEventListener(`pointerdown`,e=>{e.preventDefault(),$.scoreEvents.mobileInputSeen=!0,zd()}),Xl.addEventListener(`pointerdown`,e=>{e.preventDefault(),$.scoreEvents.mobileInputSeen=!0,Wd()}),window.addEventListener(`resize`,sf),window.addEventListener(`orientationchange`,()=>setTimeout(sf,120))}function gd(e){e.target.closest(`button`)||$.state===`playing`&&(e.preventDefault(),$.scoreEvents.mobileInputSeen=!0,e.clientX<window.innerWidth*.48&&Q.joystickPointer===null?(Q.joystickPointer=e.pointerId,_d(e.pointerId),bd(e)):Q.lookPointer===null&&(Q.lookPointer=e.pointerId,Q.lookLast.x=e.clientX,Q.lookLast.y=e.clientY,_d(e.pointerId)))}function _d(e){try{Kl.setPointerCapture?.(e)}catch{}}function vd(e){$.state===`playing`&&(e.pointerId===Q.joystickPointer?(e.preventDefault(),bd(e)):e.pointerId===Q.lookPointer&&(e.preventDefault(),Q.lookX+=e.clientX-Q.lookLast.x,Q.lookY+=e.clientY-Q.lookLast.y,Q.lookLast.x=e.clientX,Q.lookLast.y=e.clientY))}function yd(e){e.pointerId===Q.joystickPointer&&(Q.joystickPointer=null,Q.moveX=0,Q.moveY=0,Jl.style.transform=`translate(-50%, -50%)`),e.pointerId===Q.lookPointer&&(Q.lookPointer=null)}function bd(e){let t=ql.getBoundingClientRect(),n=t.left+t.width/2,r=t.top+t.height/2,i=t.width*.34,a=df(e.clientX-n,-i,i),o=df(e.clientY-r,-i,i),s=Math.hypot(a,o),c=s>i?i/s:1,l=a*c,u=o*c;Q.moveX=l/i,Q.moveY=-u/i,Jl.style.transform=`translate(calc(-50% + ${l}px), calc(-50% + ${u}px))`}function xd(){$.state!==`playing`&&(pf.unlock(),Rl.classList.add(`hidden`),zl.classList.add(`hidden`),Gl.classList.remove(`hidden`),Kl.classList.remove(`hidden`),$.state=`playing`,Kd(`The lock needs three keys.`,2.8))}function Sd(e){Bu();for(let e of $.sprayParticles)Mu.remove(e),e.geometry.dispose();X.pos.copy(rf(pu.c,pu.r,su)),X.yaw=-Math.PI/2,X.pitch=0,X.fear=0,X.keys=0,X.bob=0,X.shake=0,X.lastSafe.copy(X.pos),Z.pos.copy(rf(hu.c,hu.r,0)),Z.vel.set(0,0,0),Z.path=[],Z.pathTimer=0,Z.stun=0,Z.retreat=0,Z.barkTimer=1.2,Z.growlTimer=0,Z.biteCooldown=0,Z.flashlightExposure=0,Z.squirtHits=0,Z.flashlightRepels=0,Z.jumpscares=0,Z.lastDistance=99,Y.position.copy(Z.pos),Y.rotation.set(0,0,0),Y.visible=!0,Nu&&(Nu.visible=!1,Nu.material.opacity=0),$.time=0,$.threat=0,$.messageTimer=0,$.message=``,$.collectedKeys=[],$.sprayParticles=[],$.scoreEvents={keyPickups:0,exitUnlocked:!1,won:!1,dogRepelled:!1,jumpscareSeen:!1,mobileInputSeen:!1},Q.flashlightOn=!0,Q.sprayCooldown=0,Q.moveX=0,Q.moveY=0,Q.lookX=0,Q.lookY=0,Q.testMoveX=0,Q.testMoveY=0,Q.testLookX=0,Q.testLookY=0,Q.testUntil=0,Q.joystickPointer=null,Q.lookPointer=null,Q.keys.clear(),Jl.style.transform=`translate(-50%, -50%)`,Yl.disabled=!1,Yl.style.opacity=`1`,eu.classList.remove(`active`),tu.classList.remove(`active`),Xl.classList.add(`active`),Il.style.setProperty(`--terror`,`0`),Il.style.setProperty(`--danger`,`0`),Il.style.setProperty(`--static-opacity`,`0`);for(let e of Vu)e.visible=!0,e.userData.collected=!1;Hu&&(Hu.rotation.y=Math.PI/2),Pd(),Gd(),e?(Rl.classList.remove(`hidden`),zl.classList.add(`hidden`),Gl.classList.add(`hidden`),Kl.classList.add(`hidden`),$.state=`idle`):$.state=`idle`}function Cd(e){$.state===`won`||$.state===`lost`||($.state=e?`won`:`lost`,$.scoreEvents.won=e,$.message=``,$.messageTimer=0,$l.textContent=``,Hl.textContent=e?`Escaped`:`Caught`,Ul.textContent=e?`You made it out.`:`Nighttail found you.`,Wl.textContent=e?`The exit clicks open behind you.`:`The little growl is the last thing in the hall.`,zl.classList.remove(`hidden`),Kl.classList.add(`hidden`),!e&&Nu&&(Nu.position.set(Z.pos.x,1.05,Z.pos.z),Nu.lookAt(vu.position.x,Nu.position.y,vu.position.z),Nu.material.opacity=.82,Nu.visible=!0,Y.visible=!1),e&&pf.win())}function wd(){requestAnimationFrame(wd);let e=performance.now(),t=Math.min((e-wu)/1e3,.04);wu=e,$.time+=t,Yd(t),Td(t),Su?Su.render():bu.render(_u,vu)}function Td(e){qd(e),$.state===`playing`&&(Ed(e),Dd(e),Md(e)),$.state===`playing`&&Fd(e),$.state===`playing`&&Vd(e),$.state===`playing`&&Nd(e),$.state===`playing`&&Gd(e),Ud(e),Ad(e),jd()}function Ed(){let e=Q.lookX+Q.testLookX,t=Q.lookY+Q.testLookY;X.yaw-=e*uu,X.pitch-=t*uu,X.pitch=df(X.pitch,-1.18,1.05),Q.lookX=0,Q.lookY=0,Q.testLookX=0,Q.testLookY=0}function Dd(e){let t=Od(),n=$.time<=Q.testUntil;n||(Q.testMoveX=0,Q.testMoveY=0);let r=df(Q.moveX+(n?Q.testMoveX:0)+t.x,-1,1),i=df(Q.moveY+(n?Q.testMoveY:0)+t.y,-1,1),a=Math.hypot(r,i);a>1&&(r/=a,i/=a);let o=Zd(),s=new V(-o.z,0,o.x),c=new V().addScaledVector(o,i).addScaledVector(s,r);if(c.lengthSq()>1e-4){c.normalize();let t=lu*(1-Math.min(X.fear,70)*.0025)*e;kd(c.x*t,c.z*t),X.bob+=e*9.2,X.lastSafe.copy(X.pos)}else X.bob+=e*2.4;X.fear=Math.max(0,X.fear-e*2.4)}function Od(){let e=0,t=0;return(Q.keys.has(`KeyW`)||Q.keys.has(`ArrowUp`))&&(t+=1),(Q.keys.has(`KeyS`)||Q.keys.has(`ArrowDown`))&&--t,(Q.keys.has(`KeyA`)||Q.keys.has(`ArrowLeft`))&&--e,(Q.keys.has(`KeyD`)||Q.keys.has(`ArrowRight`))&&(e+=1),{x:e,y:t}}function kd(e,t){let n=X.pos.x+e;$d(n,X.pos.z,cu)||(X.pos.x=n);let r=X.pos.z+t;$d(X.pos.x,r,cu)||(X.pos.z=r)}function Ad(e){let t=$.state===`playing`?Math.sin(X.bob)*.024:0;X.shake=Math.max(0,X.shake-e*3.2);let n=(Tu()-.5)*X.shake*.06,r=(Tu()-.5)*X.shake*.06;vu.position.set(X.pos.x,su+t+r,X.pos.z),vu.rotation.set(X.pitch+n,X.yaw+r*.4,0)}function jd(){Fu.visible=Q.flashlightOn,Iu.visible=Q.flashlightOn;let e=Q.flashlightOn&&!yu&&window.innerWidth>700;Lu.visible=e,Xl.classList.toggle(`active`,Q.flashlightOn);let t=new V;vu.getWorldDirection(t),Fu.position.copy(vu.position),Iu.position.copy(vu.position),Fu.target.position.copy(vu.position).addScaledVector(t,12),Lu.position.copy(vu.position).addScaledVector(t,.15),Lu.quaternion.setFromUnitVectors(new V(0,-1,0),t.clone().normalize());let n=.92+Math.sin($.time*17.3)*.035+Math.sin($.time*41.7)*.02;Fu.intensity=Q.flashlightOn?78*n:0,Iu.intensity=Q.flashlightOn?.72*n:0,Lu.material.opacity=e?.04+Math.sin($.time*15)*.008:0}function Md(e){for(let t of Vu)t.userData.collected||(t.rotation.y+=e*1.6,t.position.y=t.userData.baseY+Math.sin($.time*2.6+t.userData.index)*.08,of(X.pos,t.position)<1.2&&(t.userData.collected=!0,t.visible=!1,X.keys+=1,$.collectedKeys.push(t.userData.index),$.scoreEvents.keyPickups+=1,pf.pickup(),Kd(`Key ${X.keys}/${fu}`,1.6),Pd()))}function Nd(e){X.keys>=fu&&(Hu.rotation.y=cf(Hu.rotation.y,Math.PI/2-.85,e*1.8),$.scoreEvents.exitUnlocked||($.scoreEvents.exitUnlocked=!0,Kd(`The exit is open.`,2.2)));let t=rf(mu.c,mu.r,0);of(X.pos,t)<2.35&&(X.keys>=fu?Cd(!0):$.messageTimer<=0&&(Kd(`Still locked.`,1.6),X.fear=Math.min(100,X.fear+5),pf.locked()))}function Pd(){if(!Hu)return;let e=X.keys>=fu;Hu.children[0].material=e?J.exitUnlocked:J.exit,Uu&&(Uu.intensity=e?.85:.45)}function Fd(e){Z.stun=Math.max(0,Z.stun-e),Z.retreat=Math.max(0,Z.retreat-e),Z.biteCooldown=Math.max(0,Z.biteCooldown-e),Z.pathTimer-=e;let t=new V(X.pos.x,0,X.pos.z);Z.lastDistance=Z.pos.distanceTo(t),Q.flashlightOn&&Z.lastDistance<9.5&&Xd(Z.pos,.71)&&Qd(X.pos,Z.pos)?(Z.flashlightExposure+=e,Z.retreat=Math.max(Z.retreat,.22),X.fear=Math.max(0,X.fear-e*7),Z.flashlightExposure>.42&&(Z.flashlightExposure=0,Z.flashlightRepels+=1,$.scoreEvents.dogRepelled=!0,Kd(`It backs into the dark.`,1.1))):Z.flashlightExposure=Math.max(0,Z.flashlightExposure-e*.4);let n=new V,r=Z.pos.clone().sub(t).setY(0);if(r.lengthSq()<.01&&r.set(1,0,0),Z.stun>0||Z.retreat>0)n.copy(r.normalize());else{Z.pathTimer<=0&&(Z.path=ef(af(Z.pos.x,Z.pos.z),af(X.pos.x,X.pos.z)),Z.pathTimer=.35);let e=Z.path.length>1?Z.path[1]:af(X.pos.x,X.pos.z),r=rf(e.c,e.r,0);if(n.copy(r).sub(Z.pos).setY(0),n.lengthSq()<.05&&Z.path.length>2){let e=rf(Z.path[2].c,Z.path[2].r,0);n.copy(e).sub(Z.pos).setY(0)}n.lengthSq()<.01&&n.copy(t).sub(Z.pos).setY(0)}n.lengthSq()>.001&&n.normalize();let i=1+X.keys*.12+X.fear*.004,a=Z.stun>0?.8:Z.retreat>0?1.45:1.02*i;if(Id(n.x*a*e,n.z*a*e),n.lengthSq()>.001){let t=Math.atan2(n.x,n.z);Y.rotation.y=lf(Y.rotation.y,t,e*7.5)}Y.position.set(Z.pos.x,0,Z.pos.z),Y.position.y=Math.sin($.time*8.5)*.018,Ld(e),Rd(e)}function Id(e,t){let n=Z.pos.x+e;$d(n,Z.pos.z,du)||(Z.pos.x=n);let r=Z.pos.z+t;$d(Z.pos.x,r,du)||(Z.pos.z=r)}function Ld(e){let t=Z.lastDistance;Z.barkTimer-=e,Z.growlTimer-=e,t<12&&Z.growlTimer<=0&&(pf.growl(df(1-t/12,.08,.9)),Z.growlTimer=1.4+Tu()*1.5),t<6.2&&Z.barkTimer<=0&&(pf.bark(df(1-t/7,.25,1)),Z.barkTimer=1.1+Tu()*1.6)}function Rd(e){let t=Z.lastDistance;if(t<8&&Z.stun<=0&&(X.fear=Math.min(100,X.fear+e*(8-t)*.95)),t<.72&&Z.biteCooldown<=0&&Z.stun<=0&&Z.retreat<=0){Z.biteCooldown=3.8,Z.jumpscares+=1,$.scoreEvents.jumpscareSeen=!0,X.fear=Math.min(100,X.fear+24),X.shake=Math.max(X.shake,1.4),Hd(),pf.jumpscare();let e=X.pos.clone().sub(Z.pos).setY(0);e.lengthSq()>.001&&(e.normalize().multiplyScalar(.7),kd(e.x,e.z))}X.fear>=100&&Cd(!1)}function zd(){$.state!==`playing`||Q.sprayCooldown>0||(Q.sprayCooldown=.72,X.shake=Math.max(X.shake,.18),pf.squirt(),Bd(),Z.lastDistance<8.2&&Xd(Z.pos,.67)&&Qd(X.pos,Z.pos)&&(Z.stun=3.2,Z.retreat=3.8,Z.squirtHits+=1,$.scoreEvents.dogRepelled=!0,X.fear=Math.max(0,X.fear-12),Kd(`The squirt gun buys time.`,1.4),pf.yelpAway()))}function Bd(){let e=new V;vu.getWorldDirection(e);let t=new V(-e.z,0,e.x),n=vu.position.clone().addScaledVector(e,.45).addScaledVector(t,.18);for(let r=0;r<16;r+=1){let r=new G(new zi(.035+Tu()*.035,8,6),J.water);r.position.copy(n),r.userData.vel=e.clone().multiplyScalar(7.5+Tu()*4).addScaledVector(t,(Tu()-.5)*1.1).add(new V(0,(Tu()-.2)*.45,0)),r.userData.life=.42+Tu()*.18,r.userData.maxLife=r.userData.life,Mu.add(r),$.sprayParticles.push(r)}}function Vd(e){Q.sprayCooldown=Math.max(0,Q.sprayCooldown-e),Yl.disabled=Q.sprayCooldown>.02,Yl.style.opacity=Q.sprayCooldown>0?`0.62`:`1`;for(let t=$.sprayParticles.length-1;t>=0;--t){let n=$.sprayParticles[t];n.userData.life-=e,n.userData.vel.y-=e*3.6,n.position.addScaledVector(n.userData.vel,e),n.material.opacity=Math.max(0,.68*(n.userData.life/n.userData.maxLife)),n.userData.life<=0&&(Mu.remove(n),n.geometry.dispose(),$.sprayParticles.splice(t,1))}}function Hd(){eu.classList.add(`active`),tu.classList.add(`active`),zu(()=>eu.classList.remove(`active`),1400),zu(()=>tu.classList.remove(`active`),620)}function Ud(e){let t=$.state===`playing`?df((8.5-Z.lastDistance)/7.4,0,1):0,n=$.state===`playing`?df(X.fear/100,0,1):0,r=Math.max(t,n*.85);$.threat=cf($.threat,r,df(e*5.5,0,1));let i=$.state===`playing`?df((3.2-Z.lastDistance)/2.8,0,1):0;Il.style.setProperty(`--terror`,$.threat.toFixed(3)),Il.style.setProperty(`--danger`,i.toFixed(3)),Il.style.setProperty(`--static-opacity`,($.threat*.22+i*.16).toFixed(3)),$.state===`playing`&&$.threat>.28&&(X.shake=Math.max(X.shake,$.threat*.34)),pf.setThreat($.threat,i)}function Wd(){$.state===`playing`&&(Q.flashlightOn=!Q.flashlightOn,pf.click())}function Gd(e=0){Zl.style.width=`${df(X.fear,0,100)}%`,Ql.textContent=`Keys ${X.keys}/${fu}`,$.messageTimer>0?($.messageTimer-=e,$l.textContent=$.message):$l.textContent=``}function Kd(e,t=1.6){$.message=e,$.messageTimer=t}function qd(e){for(let e of Ou.props)e.isPointLight&&(e.intensity=e.userData.baseIntensity*(.84+Math.sin($.time*7+e.userData.flicker)*.08+Tu()*.06));for(let e=0;e<Y.children.length;e+=1){let t=Y.children[e];t.geometry?.type===`CapsuleGeometry`&&(t.rotation.x=Math.sin($.time*7+e)*.12),t.userData?.wag&&t.userData.baseRotation&&(t.rotation.copy(t.userData.baseRotation),t.rotation.y+=Math.sin($.time*13)*.34,t.rotation.z+=Math.sin($.time*11)*.16),t.userData?.ear&&t.userData.baseRotation&&(t.rotation.copy(t.userData.baseRotation),t.rotation.x+=Math.sin($.time*5.4+e)*.035),t.userData?.furTuft&&t.userData.baseRotation&&(t.rotation.copy(t.userData.baseRotation),t.rotation.x+=Math.sin($.time*8.5+e*.37)*.035)}Cu&&(Cu.strength=yu?.13+X.fear*.001:.19+X.fear*.0012),Jd()}function Jd(){if(!Nu)return;let e=$.state===`lost`||$.state===`playing`&&Z.lastDistance<3.45;if(Nu.visible=e,Y.visible=!e,!e){Nu.material.opacity=0;return}let t=df((3.45-Z.lastDistance)/2.15,.18,.92);Nu.position.set(Z.pos.x,1.05+Math.sin($.time*8.5)*.02,Z.pos.z),Nu.lookAt(vu.position.x,Nu.position.y,vu.position.z),Nu.material.opacity=t}function Yd(e){$.fpsTimer+=e,$.fpsFrames+=1,$.fpsTimer>=.5&&($.fps=Math.round($.fpsFrames/$.fpsTimer),$.fpsTimer=0,$.fpsFrames=0)}function Xd(e,t){let n=new V;vu.getWorldDirection(n),n.y=0,n.normalize();let r=new V(e.x-X.pos.x,0,e.z-X.pos.z);return r.lengthSq()<.001?!0:(r.normalize(),n.dot(r)>t)}function Zd(){let e=new V;return vu.getWorldDirection(e),e.y=0,e.lengthSq()<.001&&e.set(0,0,-1),e.normalize()}function Qd(e,t){let n=t.x-e.x,r=t.z-e.z,i=Math.max(2,Math.ceil(Math.hypot(n,r)/(ru*.34)));for(let t=1;t<i;t+=1){let a=t/i,o=af(e.x+n*a,e.z+r*a);if(!tf(o.c,o.r))return!1}return!0}function $d(e,t,n){let r=af(e,t);for(let i=r.r-1;i<=r.r+1;i+=1)for(let a=r.c-1;a<=r.c+1;a+=1){if(!Du.has(`${a},${i}`))continue;let r={minX:(a-au/2)*ru,maxX:(a-au/2+1)*ru,minZ:(i-iu/2)*ru,maxZ:(i-iu/2+1)*ru},o=df(e,r.minX,r.maxX),s=df(t,r.minZ,r.maxZ);if(Math.hypot(e-o,t-s)<n)return!0}return!1}function ef(e,t){if(!tf(e.c,e.r)||!tf(t.c,t.r))return[e];let n=[e],r=new Map,i=`${e.c},${e.r}`;r.set(i,null);let a=[{c:1,r:0},{c:-1,r:0},{c:0,r:1},{c:0,r:-1}];for(;n.length;){let e=n.shift();if(e.c===t.c&&e.r===t.r)break;for(let t of a){let i={c:e.c+t.c,r:e.r+t.r},a=`${i.c},${i.r}`;r.has(a)||!tf(i.c,i.r)||(r.set(a,e),n.push(i))}}let o=`${t.c},${t.r}`;if(!r.has(o))return[e];let s=[],c=t;for(;c;)s.push(c),c=r.get(`${c.c},${c.r}`);return s.reverse()}function tf(e,t){return t>=0&&t<iu&&e>=0&&e<au&&Eu[t][e]!==`#`}function nf(e,t){return{x:(e-au/2)*ru+ru/2,z:(t-iu/2)*ru+ru/2}}function rf(e,t,n=0){let r=nf(e,t);return new V(r.x,n,r.z)}function af(e,t){return{c:df(Math.floor(e/ru+au/2),0,au-1),r:df(Math.floor(t/ru+iu/2),0,iu-1)}}function of(e,t){return Math.hypot(e.x-t.x,e.z-t.z)}function sf(){bu.setPixelRatio(Math.min(window.devicePixelRatio||1,xu)),bu.setSize(window.innerWidth,window.innerHeight,!1),vu.aspect=window.innerWidth/window.innerHeight,vu.updateProjectionMatrix(),Su&&Su.setSize(window.innerWidth,window.innerHeight),Cu&&Cu.setSize(window.innerWidth,window.innerHeight)}function cf(e,t,n){return e+(t-e)*df(n,0,1)}function lf(e,t,n){return e+uf(t-e)*df(n,0,1)}function uf(e){return Math.atan2(Math.sin(e),Math.cos(e))}function df(e,t,n){return Math.max(t,Math.min(n,e))}function ff(e){return function(){let t=e+=1831565813;return t=Math.imul(t^t>>>15,t|1),t^=t+Math.imul(t^t>>>7,t|61),((t^t>>>14)>>>0)/4294967296}}var pf={ctx:null,master:null,ambient:null,heartbeatTimer:0,unlocked:!1,unlock(){if(this.unlocked)return;let e=window.AudioContext||window.webkitAudioContext;e&&(this.ctx=new e,this.master=this.ctx.createGain(),this.master.gain.value=.58,this.master.connect(this.ctx.destination),this.unlocked=!0,this.startAmbience())},startAmbience(){if(!this.ctx||this.ambient)return;let e=this.ctx.currentTime,t=this.ctx.createOscillator(),n=this.ctx.createOscillator(),r=this.ctx.createOscillator(),i=this.ctx.createGain(),a=this.ctx.createGain(),o=this.ctx.createGain(),s=this.ctx.createGain(),c=this.ctx.createBiquadFilter();t.type=`sawtooth`,n.type=`sine`,r.type=`triangle`,t.frequency.setValueAtTime(42,e),n.frequency.setValueAtTime(29,e),r.frequency.setValueAtTime(229,e),i.gain.value=.018,a.gain.value=.026,o.gain.value=1e-4;let l=Math.floor(this.ctx.sampleRate*2),u=this.ctx.createBuffer(1,l,this.ctx.sampleRate),d=u.getChannelData(0);for(let e=0;e<l;e+=1)d[e]=(Math.random()*2-1)*.34;let f=this.ctx.createBufferSource();f.buffer=u,f.loop=!0,c.type=`bandpass`,c.frequency.value=520,c.Q.value=.55,s.gain.value=.012,t.connect(i),n.connect(a),r.connect(o),f.connect(c),c.connect(s),i.connect(this.master),a.connect(this.master),o.connect(this.master),s.connect(this.master),t.start(e),n.start(e),r.start(e),f.start(e),this.ambient={drone:t,undertone:n,tension:r,droneGain:i,undertoneGain:a,tensionGain:o,noiseGain:s,noiseFilter:c}},setThreat(e=0,t=0){if(!this.ctx||!this.ambient)return;let n=this.ctx.currentTime,r=df(e,0,1),i=df(t,0,1);this.ambient.drone.frequency.setTargetAtTime(38+r*18,n,.18),this.ambient.undertone.frequency.setTargetAtTime(27+i*8,n,.16),this.ambient.tension.frequency.setTargetAtTime(212+r*76+Math.sin($.time*9)*r*7,n,.08),this.ambient.droneGain.gain.setTargetAtTime(.018+r*.032,n,.12),this.ambient.undertoneGain.gain.setTargetAtTime(.026+i*.035,n,.12),this.ambient.tensionGain.gain.setTargetAtTime(1e-4+Math.max(0,r-.2)*.038,n,.1),this.ambient.noiseGain.gain.setTargetAtTime(.012+r*.03+i*.028,n,.08),this.ambient.noiseFilter.frequency.setTargetAtTime(420+r*1500,n,.12),this.heartbeatTimer-=1/60,i>.18&&this.heartbeatTimer<=0&&(this.heartbeatTimer=Math.max(.24,.86-i*.48),this.heartbeat(.25+i*.22))},heartbeat(e=.24){this.tone(`sine`,74,.11,e,-18),zu(()=>this.tone(`sine`,59,.13,e*.65,-12),145)},tone(e,t,n,r=.14,i=0){if(!this.ctx)return;let a=this.ctx.currentTime,o=this.ctx.createOscillator(),s=this.ctx.createGain();o.type=e,o.frequency.setValueAtTime(t,a),i&&o.frequency.exponentialRampToValueAtTime(Math.max(20,t+i),a+n),s.gain.setValueAtTime(1e-4,a),s.gain.exponentialRampToValueAtTime(r,a+.02),s.gain.exponentialRampToValueAtTime(1e-4,a+n),o.connect(s),s.connect(this.master),o.start(a),o.stop(a+n+.03)},noise(e,t=.08,n=1200){if(!this.ctx)return;let r=Math.max(1,Math.floor(this.ctx.sampleRate*e)),i=this.ctx.createBuffer(1,r,this.ctx.sampleRate),a=i.getChannelData(0);for(let e=0;e<r;e+=1)a[e]=Math.random()*2-1;let o=this.ctx.createBufferSource(),s=this.ctx.createBiquadFilter(),c=this.ctx.createGain();s.type=`bandpass`,s.frequency.value=n,s.Q.value=.9,c.gain.setValueAtTime(t,this.ctx.currentTime),c.gain.exponentialRampToValueAtTime(1e-4,this.ctx.currentTime+e),o.buffer=i,o.connect(s),s.connect(c),c.connect(this.master),o.start(),o.stop(this.ctx.currentTime+e)},growl(e){this.tone(`sawtooth`,58+e*26,.35,.05+e*.08,-12),this.noise(.25,.02+e*.04,180)},bark(e=1){this.tone(`square`,340+e*90,.095,.09+e*.08,-150),zu(()=>this.tone(`square`,270,.08,.06,-90),78)},jumpscare(){this.noise(.42,.34,650),this.tone(`sawtooth`,90,.48,.24,-40),this.bark(1)},squirt(){this.noise(.18,.12,1850)},yelpAway(){this.tone(`sine`,540,.17,.08,180)},pickup(){this.tone(`triangle`,700,.12,.08,260),zu(()=>this.tone(`triangle`,960,.12,.06,90),90)},locked(){this.tone(`square`,120,.14,.08,-30)},click(){this.tone(`square`,920,.035,.035,-200)},win(){this.tone(`triangle`,440,.18,.08,220),zu(()=>this.tone(`triangle`,660,.22,.08,160),160),zu(()=>this.tone(`triangle`,980,.28,.07,100),340)}};wd(),nu&&(window.__NIGHTTAIL_TEST__={start(){xd()},reset(){Sd(!1),xd()},setInput(e){Q.testMoveX=df(e.moveX??0,-1,1),Q.testMoveY=df(e.moveY??0,-1,1),Q.testLookX=df(e.lookX??0,-90,90),Q.testLookY=df(e.lookY??0,-60,60),Q.testUntil=$.time+df(e.hold??.28,.04,.5)},fire(){zd()},stageDogBiteTest(){let e=new V(X.pos.x,0,X.pos.z);Q.flashlightOn=!1,Z.pos.copy(e).addScaledVector(Zd(),.48),Z.vel.set(0,0,0),Z.path=[],Z.pathTimer=0,Z.stun=0,Z.retreat=0,Z.biteCooldown=0,Z.lastDistance=of(X.pos,Z.pos),Y.position.copy(Z.pos),X.fear=Math.min(X.fear,20)},stageDogEncounterTest(e=2.15){let t=new V(X.pos.x,0,X.pos.z);Z.pos.copy(t).addScaledVector(Zd(),df(e,1.2,4.2)),Z.vel.set(0,0,0),Z.path=[],Z.pathTimer=0,Z.stun=0,Z.retreat=0,Z.biteCooldown=1.2,Z.flashlightExposure=0,Z.lastDistance=of(X.pos,Z.pos),Y.position.copy(Z.pos),Y.lookAt(X.pos.x,Y.position.y,X.pos.z),X.fear=Math.max(X.fear,34),$.threat=Math.max($.threat,.62),Il.style.setProperty(`--terror`,$.threat.toFixed(3)),Il.style.setProperty(`--danger`,`0.28`),Il.style.setProperty(`--static-opacity`,`0.22`),Nu&&(Nu.position.set(Z.pos.x,1.05,Z.pos.z),Nu.lookAt(vu.position.x,Nu.position.y,vu.position.z),Nu.material.opacity=.72,Nu.visible=!0,Y.visible=!1)},forceLoseTest(){X.fear=100,Cd(!1)},setFlashlight(e){Q.flashlightOn=!!e},snapshot(){return{state:$.state,player:{x:X.pos.x,z:X.pos.z,yaw:X.yaw,pitch:X.pitch,fear:X.fear,keys:X.keys},dog:{x:Z.pos.x,z:Z.pos.z,distance:Z.lastDistance,stun:Z.stun,retreat:Z.retreat,squirtHits:Z.squirtHits,flashlightRepels:Z.flashlightRepels,jumpscares:Z.jumpscares,radius:du,visualScale:Y.scale.x,photoCardVisible:!!Nu?.visible},effects:{threat:$.threat,staticOpacity:Number(getComputedStyle(Il).getPropertyValue(`--static-opacity`))||0,danger:Number(getComputedStyle(Il).getPropertyValue(`--danger`))||0},audio:{unlocked:pf.unlocked,ambientActive:!!pf.ambient},keys:Vu.map(e=>({index:e.userData.index,collected:e.userData.collected,x:e.position.x,z:e.position.z,cell:e.userData.cell})),exit:{x:nf(mu.c,mu.r).x,z:nf(mu.c,mu.r).z,cell:mu,unlocked:X.keys>=fu},grid:Eu.map(e=>e.join(``)),cellSize:ru,rows:iu,cols:au,fps:$.fps,events:{...$.scoreEvents},mobileUi:{joystick:!!ql.offsetWidth,sprayButton:!!Yl.offsetWidth,flashlightButton:!!Xl.offsetWidth}}},cellToWorld(e,t){return nf(e,t)},pathToCell(e){return ef(af(X.pos.x,X.pos.z),e).map(e=>({...e,...nf(e.c,e.r)}))}});
//# sourceMappingURL=index-yXaOSAnm.js.map